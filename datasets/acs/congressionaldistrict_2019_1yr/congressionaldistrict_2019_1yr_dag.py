...
with DAG(
    dag_id="acs.congressionaldistrict_2019_1yr",
    ...
    congressionaldistrict_2019_1yr_transform_csv = kubernetes_pod_operator.KubernetesPodOperator(
        ...
        env_vars={
            ...
            "TARGET_GCS_PATH": "data/acs/congressionaldistrict_2019_1yr/data_output.csv",
    ...
    load_congressionaldistrict_2019_1yr_to_bq = gcs_to_bq.GoogleCloudStorageToBigQueryOperator(
        ...
        source_objects=["data/acs/congressionaldistrict_2019_1yr/data_output.csv"],
        source_format="CSV",
        destination_project_dataset_table="acs.congressionaldistrict_2019_1yr",
        skip_leading_rows=1,
