...
with DAG(
    ...
    puma_2019_1yr_transform_csv = kubernetes_pod_operator.KubernetesPodOperator(
        ...
        env_vars={
            ...
            "TARGET_GCS_PATH": "data/acs/puma_2019_1yr/data_output.csv",
    ...
    load_puma_2019_1yr_to_bq = gcs_to_bq.GoogleCloudStorageToBigQueryOperator(
        task_id="load_puma_2019_1yr_to_bq",
        bucket="{{ var.value.composer_bucket }}",
        source_objects=["data/acs/puma_2019_1yr/data_output.csv"],
        source_format="CSV",
        destination_project_dataset_table="acs.puma_2019_1yr",
        skip_leading_rows=1,
