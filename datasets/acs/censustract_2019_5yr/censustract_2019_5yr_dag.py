...
with DAG(
    dag_id="acs.censustract_2019_5yr",
    ...
    censustract_2019_5yr_transform_csv = kubernetes_pod_operator.KubernetesPodOperator(
        ...
        env_vars={
            ...
            "TARGET_GCS_PATH": "data/acs/censustract_2019_5yr/data_output.csv",
        },
    ...
    load_censustract_2019_5yr_to_bq = gcs_to_bq.GoogleCloudStorageToBigQueryOperator(
        ...
        source_objects=["data/acs/censustract_2019_5yr/data_output.csv"],
        source_format="CSV",
        destination_project_dataset_table="acs.censustract_2019_5yr",
        skip_leading_rows=1,
