...
with DAG(
    ...
    past_week_transform_csv = kubernetes_pod_operator.KubernetesPodOperator(
        ...
        image="{{ var.json.past_week.container_registry.run_csv_transform_kub }}",
        env_vars={
            ...
            "TARGET_GCS_PATH": "data/past_week/past_week/data_output.csv",
    ...
    load_past_week_to_bq = gcs_to_bq.GoogleCloudStorageToBigQueryOperator(
        ...
        source_objects=["data/past_week/past_week/data_output.csv"],
        source_format="CSV",
        destination_project_dataset_table="past_week.past_week",
        skip_leading_rows=1,
