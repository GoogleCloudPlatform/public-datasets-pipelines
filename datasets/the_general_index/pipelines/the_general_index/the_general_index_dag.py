...
with DAG(
    ...
    transform_csv_dump_0 = kubernetes_engine.GKEStartPodOperator(
        ...
        image="{{ var.json.the_general_index.container_registry.the_general_index__run_csv_transform_kub }}",
        env_vars={
            "PROJECT_ID": "{{ var.value.gcp_project }}",
            "TARGET_GCS_BUCKET": "{{ var.value.composer_bucket }}",
            "CHUNKSIZE": "{{ var.json.the_general_index.chunksize }}",
            "DATASET_ID": "{{ var.json.the_general_index.dump_0.dataset_id }}",
            ...
            "PIPELINE_NAME": "{{ var.json.the_general_index.pipeline_name }}",
            "SOURCE_URL": "{{ var.json.the_general_index.dump_0.source_url }}",
            "SOURCE_FILE": "{{ var.json.the_general_index.dump_0.source_file }}",
            "TARGET_FILE": "{{ var.json.the_general_index.dump_0.target_url }}",
            "TARGET_GCS_PATH": "{{ var.json.the_general_index.dump_0.target_path }}",
            "INPUT_CSV_HEADERS": '[\n  "dkey",\n  "raw_id",\n  "meta_key",\n  "doc_doi",\n  "meta_doi",\n  "doi",\n  "doi_flag",\n  "isbn",\n  "journal",\n  "doc_title",\n  "meta_title",\n  "title",\n  "doc_pub_date",\n  "meta_pub_date",\n  "pub_date",\n  "doc_author",\n  "meta_author",\n  "author",\n  "doc_size",\n  "insert_date",\n  "multi_row_flag"\n]',
            "DATA_DTYPES": '{\n  "dkey": "str",\n  "raw_id": "str",\n  "meta_key": "str",\n  "doc_doi": "str",\n  "meta_doi": "str",\n  "doi": "str",\n  "doi_flag": "str",\n  "isbn": "str",\n  "journal": "str",\n  "doc_title": "str",\n  "meta_title": "str",\n  "title": "str",\n  "doc_pub_date": "str",\n  "meta_pub_date": "str",\n  "pub_date": "str",\n  "doc_author": "str",\n  "meta_author": "str",\n  "author": "str",\n  "doc_size": "str",\n  "insert_date": "str",\n  "multi_row_flag": "str"\n}',
            "DATETIME_LIST": '[ \n  "insert_date" \n] ',
            "NULL_STRING_LIST": '[\n  "dkey",\n  "raw_id",\n  "meta_key",\n  "doc_doi",\n  "meta_doi",\n  "doi",\n  "doi_flag",\n  "isbn",\n  "journal",\n  "doc_title",\n  "meta_title",\n  "title",\n  "doc_pub_date",\n  "meta_pub_date",\n  "pub_date",\n  "doc_author",\n  "meta_author",\n  "author",\n  "doc_size",\n  "insert_date",\n  "multi_row_flag"\n]',
    ...
    transform_csv_dump_1 = kubernetes_engine.GKEStartPodOperator(
        ...
        env_vars={
            ...
            "TARGET_GCS_BUCKET": "{{ var.value.composer_bucket }}",
            "CHUNKSIZE": "{{ var.json.the_general_index.chunksize }}",
            "DATASET_ID": "{{ var.json.the_general_index.dump_1.dataset_id }}",
            "TABLE_ID": "{{ var.json.the_general_index.destination_table }}",
            "SCHEMA_PATH": "{{ var.json.the_general_index.schema_path }}",
            "SOURCE_FILE_HEADER_ROWS": "{{ var.json.the_general_index.source_file_header_rows }}",
            "SOURCE_FILE_FOOTER_ROWS": "{{ var.json.the_general_index.source_file_footer_rows }}",
            ...
            "TARGET_FILE": "{{ var.json.the_general_index.dump_1.target_url }}",
            "TARGET_GCS_PATH": "{{ var.json.the_general_index.dump_1.target_path }}",
            "INPUT_CSV_HEADERS": '[\n  "dkey",\n  "raw_id",\n  "meta_key",\n  "doc_doi",\n  "meta_doi",\n  "doi",\n  "doi_flag",\n  "isbn",\n  "journal",\n  "doc_title",\n  "meta_title",\n  "title",\n  "doc_pub_date",\n  "meta_pub_date",\n  "pub_date",\n  "doc_author",\n  "meta_author",\n  "author",\n  "doc_size",\n  "insert_date",\n  "multi_row_flag"\n]',
            "DATA_DTYPES": '{\n  "dkey": "str",\n  "raw_id": "str",\n  "meta_key": "str",\n  "doc_doi": "str",\n  "meta_doi": "str",\n  "doi": "str",\n  "doi_flag": "str",\n  "isbn": "str",\n  "journal": "str",\n  "doc_title": "str",\n  "meta_title": "str",\n  "title": "str",\n  "doc_pub_date": "str",\n  "meta_pub_date": "str",\n  "pub_date": "str",\n  "doc_author": "str",\n  "meta_author": "str",\n  "author": "str",\n  "doc_size": "str",\n  "insert_date": "str",\n  "multi_row_flag": "str"\n}',
            "DATETIME_LIST": '[ \n  "insert_date" \n] ',
            "NULL_STRING_LIST": '[\n  "dkey",\n  "raw_id",\n  "meta_key",\n  "doc_doi",\n  "meta_doi",\n  "doi",\n  "doi_flag",\n  "isbn",\n  "journal",\n  "doc_title",\n  "meta_title",\n  "title",\n  "doc_pub_date",\n  "meta_pub_date",\n  "pub_date",\n  "doc_author",\n  "meta_author",\n  "author",\n  "doc_size",\n  "insert_date",\n  "multi_row_flag"\n]',
    ...
    transform_csv_dump_2 = kubernetes_engine.GKEStartPodOperator(
        ...
        env_vars={
            ...
            "TARGET_GCS_BUCKET": "{{ var.value.composer_bucket }}",
            "CHUNKSIZE": "{{ var.json.the_general_index.chunksize }}",
            "DATASET_ID": "{{ var.json.the_general_index.dump_2.dataset_id }}",
            "TABLE_ID": "{{ var.json.the_general_index.destination_table }}",
            "SCHEMA_PATH": "{{ var.json.the_general_index.schema_path }}",
            "SOURCE_FILE_HEADER_ROWS": "{{ var.json.the_general_index.source_file_header_rows }}",
            "SOURCE_FILE_FOOTER_ROWS": "{{ var.json.the_general_index.source_file_footer_rows }}",
            ...
            "TARGET_FILE": "{{ var.json.the_general_index.dump_2.target_url }}",
            "TARGET_GCS_PATH": "{{ var.json.the_general_index.dump_2.target_path }}",
            "INPUT_CSV_HEADERS": '[\n  "dkey",\n  "raw_id",\n  "meta_key",\n  "doc_doi",\n  "meta_doi",\n  "doi",\n  "doi_flag",\n  "isbn",\n  "journal",\n  "doc_title",\n  "meta_title",\n  "title",\n  "doc_pub_date",\n  "meta_pub_date",\n  "pub_date",\n  "doc_author",\n  "meta_author",\n  "author",\n  "doc_size",\n  "insert_date",\n  "multi_row_flag"\n]',
            "DATA_DTYPES": '{\n  "dkey": "str",\n  "raw_id": "str",\n  "meta_key": "str",\n  "doc_doi": "str",\n  "meta_doi": "str",\n  "doi": "str",\n  "doi_flag": "str",\n  "isbn": "str",\n  "journal": "str",\n  "doc_title": "str",\n  "meta_title": "str",\n  "title": "str",\n  "doc_pub_date": "str",\n  "meta_pub_date": "str",\n  "pub_date": "str",\n  "doc_author": "str",\n  "meta_author": "str",\n  "author": "str",\n  "doc_size": "str",\n  "insert_date": "str",\n  "multi_row_flag": "str"\n}',
            "DATETIME_LIST": '[ \n  "insert_date" \n] ',
            "NULL_STRING_LIST": '[\n  "dkey",\n  "raw_id",\n  "meta_key",\n  "doc_doi",\n  "meta_doi",\n  "doi",\n  "doi_flag",\n  "isbn",\n  "journal",\n  "doc_title",\n  "meta_title",\n  "title",\n  "doc_pub_date",\n  "meta_pub_date",\n  "pub_date",\n  "doc_author",\n  "meta_author",\n  "author",\n  "doc_size",\n  "insert_date",\n  "multi_row_flag"\n]',
    ...
    transform_csv_dump_3 = kubernetes_engine.GKEStartPodOperator(
        ...
        env_vars={
            ...
            "TARGET_GCS_BUCKET": "{{ var.value.composer_bucket }}",
            "CHUNKSIZE": "{{ var.json.the_general_index.chunksize }}",
            "DATASET_ID": "{{ var.json.the_general_index.dump_3.dataset_id }}",
            "TABLE_ID": "{{ var.json.the_general_index.destination_table }}",
            "SCHEMA_PATH": "{{ var.json.the_general_index.schema_path }}",
            "SOURCE_FILE_HEADER_ROWS": "{{ var.json.the_general_index.source_file_header_rows }}",
            "SOURCE_FILE_FOOTER_ROWS": "{{ var.json.the_general_index.source_file_footer_rows }}",
            ...
            "TARGET_FILE": "{{ var.json.the_general_index.dump_3.target_url }}",
            "TARGET_GCS_PATH": "{{ var.json.the_general_index.dump_3.target_path }}",
            "INPUT_CSV_HEADERS": '[\n  "dkey",\n  "raw_id",\n  "meta_key",\n  "doc_doi",\n  "meta_doi",\n  "doi",\n  "doi_flag",\n  "isbn",\n  "journal",\n  "doc_title",\n  "meta_title",\n  "title",\n  "doc_pub_date",\n  "meta_pub_date",\n  "pub_date",\n  "doc_author",\n  "meta_author",\n  "author",\n  "doc_size",\n  "insert_date",\n  "multi_row_flag"\n]',
            "DATA_DTYPES": '{\n  "dkey": "str",\n  "raw_id": "str",\n  "meta_key": "str",\n  "doc_doi": "str",\n  "meta_doi": "str",\n  "doi": "str",\n  "doi_flag": "str",\n  "isbn": "str",\n  "journal": "str",\n  "doc_title": "str",\n  "meta_title": "str",\n  "title": "str",\n  "doc_pub_date": "str",\n  "meta_pub_date": "str",\n  "pub_date": "str",\n  "doc_author": "str",\n  "meta_author": "str",\n  "author": "str",\n  "doc_size": "str",\n  "insert_date": "str",\n  "multi_row_flag": "str"\n}',
            "DATETIME_LIST": '[ \n  "insert_date" \n] ',
            "NULL_STRING_LIST": '[\n  "dkey",\n  "raw_id",\n  "meta_key",\n  "doc_doi",\n  "meta_doi",\n  "doi",\n  "doi_flag",\n  "isbn",\n  "journal",\n  "doc_title",\n  "meta_title",\n  "title",\n  "doc_pub_date",\n  "meta_pub_date",\n  "pub_date",\n  "doc_author",\n  "meta_author",\n  "author",\n  "doc_size",\n  "insert_date",\n  "multi_row_flag"\n]',
    ...
    transform_csv_dump_4 = kubernetes_engine.GKEStartPodOperator(
        ...
        env_vars={
            ...
            "TARGET_GCS_BUCKET": "{{ var.value.composer_bucket }}",
            "CHUNKSIZE": "{{ var.json.the_general_index.chunksize }}",
            "DATASET_ID": "{{ var.json.the_general_index.dump_4.dataset_id }}",
            "TABLE_ID": "{{ var.json.the_general_index.destination_table }}",
            "SCHEMA_PATH": "{{ var.json.the_general_index.schema_path }}",
            "SOURCE_FILE_HEADER_ROWS": "{{ var.json.the_general_index.source_file_header_rows }}",
            "SOURCE_FILE_FOOTER_ROWS": "{{ var.json.the_general_index.source_file_footer_rows }}",
            ...
            "TARGET_FILE": "{{ var.json.the_general_index.dump_4.target_url }}",
            "TARGET_GCS_PATH": "{{ var.json.the_general_index.dump_4.target_path }}",
            "INPUT_CSV_HEADERS": '[\n  "dkey",\n  "raw_id",\n  "meta_key",\n  "doc_doi",\n  "meta_doi",\n  "doi",\n  "doi_flag",\n  "isbn",\n  "journal",\n  "doc_title",\n  "meta_title",\n  "title",\n  "doc_pub_date",\n  "meta_pub_date",\n  "pub_date",\n  "doc_author",\n  "meta_author",\n  "author",\n  "doc_size",\n  "insert_date",\n  "multi_row_flag"\n]',
            "DATA_DTYPES": '{\n  "dkey": "str",\n  "raw_id": "str",\n  "meta_key": "str",\n  "doc_doi": "str",\n  "meta_doi": "str",\n  "doi": "str",\n  "doi_flag": "str",\n  "isbn": "str",\n  "journal": "str",\n  "doc_title": "str",\n  "meta_title": "str",\n  "title": "str",\n  "doc_pub_date": "str",\n  "meta_pub_date": "str",\n  "pub_date": "str",\n  "doc_author": "str",\n  "meta_author": "str",\n  "author": "str",\n  "doc_size": "str",\n  "insert_date": "str",\n  "multi_row_flag": "str"\n}',
            "DATETIME_LIST": '[ \n  "insert_date" \n] ',
            "NULL_STRING_LIST": '[\n  "dkey",\n  "raw_id",\n  "meta_key",\n  "doc_doi",\n  "meta_doi",\n  "doi",\n  "doi_flag",\n  "isbn",\n  "journal",\n  "doc_title",\n  "meta_title",\n  "title",\n  "doc_pub_date",\n  "meta_pub_date",\n  "pub_date",\n  "doc_author",\n  "meta_author",\n  "author",\n  "doc_size",\n  "insert_date",\n  "multi_row_flag"\n]',
    ...
    transform_csv_dump_5 = kubernetes_engine.GKEStartPodOperator(
        ...
        env_vars={
            ...
            "TARGET_GCS_BUCKET": "{{ var.value.composer_bucket }}",
            "CHUNKSIZE": "{{ var.json.the_general_index.chunksize }}",
            "DATASET_ID": "{{ var.json.the_general_index.dump_5.dataset_id }}",
            "TABLE_ID": "{{ var.json.the_general_index.destination_table }}",
            "SCHEMA_PATH": "{{ var.json.the_general_index.schema_path }}",
            "SOURCE_FILE_HEADER_ROWS": "{{ var.json.the_general_index.source_file_header_rows }}",
            "SOURCE_FILE_FOOTER_ROWS": "{{ var.json.the_general_index.source_file_footer_rows }}",
            ...
            "TARGET_FILE": "{{ var.json.the_general_index.dump_5.target_url }}",
            "TARGET_GCS_PATH": "{{ var.json.the_general_index.dump_5.target_path }}",
            "INPUT_CSV_HEADERS": '[\n  "dkey",\n  "raw_id",\n  "meta_key",\n  "doc_doi",\n  "meta_doi",\n  "doi",\n  "doi_flag",\n  "isbn",\n  "journal",\n  "doc_title",\n  "meta_title",\n  "title",\n  "doc_pub_date",\n  "meta_pub_date",\n  "pub_date",\n  "doc_author",\n  "meta_author",\n  "author",\n  "doc_size",\n  "insert_date",\n  "multi_row_flag"\n]',
            "DATA_DTYPES": '{\n  "dkey": "str",\n  "raw_id": "str",\n  "meta_key": "str",\n  "doc_doi": "str",\n  "meta_doi": "str",\n  "doi": "str",\n  "doi_flag": "str",\n  "isbn": "str",\n  "journal": "str",\n  "doc_title": "str",\n  "meta_title": "str",\n  "title": "str",\n  "doc_pub_date": "str",\n  "meta_pub_date": "str",\n  "pub_date": "str",\n  "doc_author": "str",\n  "meta_author": "str",\n  "author": "str",\n  "doc_size": "str",\n  "insert_date": "str",\n  "multi_row_flag": "str"\n}',
            "DATETIME_LIST": '[ \n  "insert_date" \n] ',
            "NULL_STRING_LIST": '[\n  "dkey",\n  "raw_id",\n  "meta_key",\n  "doc_doi",\n  "meta_doi",\n  "doi",\n  "doi_flag",\n  "isbn",\n  "journal",\n  "doc_title",\n  "meta_title",\n  "title",\n  "doc_pub_date",\n  "meta_pub_date",\n  "pub_date",\n  "doc_author",\n  "meta_author",\n  "author",\n  "doc_size",\n  "insert_date",\n  "multi_row_flag"\n]',
    ...
    transform_csv_dump_6 = kubernetes_engine.GKEStartPodOperator(
        ...
        env_vars={
            ...
            "TARGET_GCS_BUCKET": "{{ var.value.composer_bucket }}",
            "CHUNKSIZE": "{{ var.json.the_general_index.chunksize }}",
            "DATASET_ID": "{{ var.json.the_general_index.dump_6.dataset_id }}",
            "TABLE_ID": "{{ var.json.the_general_index.destination_table }}",
            "SCHEMA_PATH": "{{ var.json.the_general_index.schema_path }}",
            "SOURCE_FILE_HEADER_ROWS": "{{ var.json.the_general_index.source_file_header_rows }}",
            "SOURCE_FILE_FOOTER_ROWS": "{{ var.json.the_general_index.source_file_footer_rows }}",
            ...
            "TARGET_FILE": "{{ var.json.the_general_index.dump_6.target_url }}",
            "TARGET_GCS_PATH": "{{ var.json.the_general_index.dump_6.target_path }}",
            "INPUT_CSV_HEADERS": '[\n  "dkey",\n  "raw_id",\n  "meta_key",\n  "doc_doi",\n  "meta_doi",\n  "doi",\n  "doi_flag",\n  "isbn",\n  "journal",\n  "doc_title",\n  "meta_title",\n  "title",\n  "doc_pub_date",\n  "meta_pub_date",\n  "pub_date",\n  "doc_author",\n  "meta_author",\n  "author",\n  "doc_size",\n  "insert_date",\n  "multi_row_flag"\n]',
            "DATA_DTYPES": '{\n  "dkey": "str",\n  "raw_id": "str",\n  "meta_key": "str",\n  "doc_doi": "str",\n  "meta_doi": "str",\n  "doi": "str",\n  "doi_flag": "str",\n  "isbn": "str",\n  "journal": "str",\n  "doc_title": "str",\n  "meta_title": "str",\n  "title": "str",\n  "doc_pub_date": "str",\n  "meta_pub_date": "str",\n  "pub_date": "str",\n  "doc_author": "str",\n  "meta_author": "str",\n  "author": "str",\n  "doc_size": "str",\n  "insert_date": "str",\n  "multi_row_flag": "str"\n}',
            "DATETIME_LIST": '[ \n  "insert_date" \n] ',
            "NULL_STRING_LIST": '[\n  "dkey",\n  "raw_id",\n  "meta_key",\n  "doc_doi",\n  "meta_doi",\n  "doi",\n  "doi_flag",\n  "isbn",\n  "journal",\n  "doc_title",\n  "meta_title",\n  "title",\n  "doc_pub_date",\n  "meta_pub_date",\n  "pub_date",\n  "doc_author",\n  "meta_author",\n  "author",\n  "doc_size",\n  "insert_date",\n  "multi_row_flag"\n]',
    ...
    transform_csv_dump_7 = kubernetes_engine.GKEStartPodOperator(
        ...
        env_vars={
            ...
            "TARGET_GCS_BUCKET": "{{ var.value.composer_bucket }}",
            "CHUNKSIZE": "{{ var.json.the_general_index.chunksize }}",
            "DATASET_ID": "{{ var.json.the_general_index.dump_7.dataset_id }}",
            "TABLE_ID": "{{ var.json.the_general_index.destination_table }}",
            "SCHEMA_PATH": "{{ var.json.the_general_index.schema_path }}",
            "SOURCE_FILE_HEADER_ROWS": "{{ var.json.the_general_index.source_file_header_rows }}",
            "SOURCE_FILE_FOOTER_ROWS": "{{ var.json.the_general_index.source_file_footer_rows }}",
            ...
            "TARGET_FILE": "{{ var.json.the_general_index.dump_7.target_url }}",
            "TARGET_GCS_PATH": "{{ var.json.the_general_index.dump_7.target_path }}",
            "INPUT_CSV_HEADERS": '[\n  "dkey",\n  "raw_id",\n  "meta_key",\n  "doc_doi",\n  "meta_doi",\n  "doi",\n  "doi_flag",\n  "isbn",\n  "journal",\n  "doc_title",\n  "meta_title",\n  "title",\n  "doc_pub_date",\n  "meta_pub_date",\n  "pub_date",\n  "doc_author",\n  "meta_author",\n  "author",\n  "doc_size",\n  "insert_date",\n  "multi_row_flag"\n]',
            "DATA_DTYPES": '{\n  "dkey": "str",\n  "raw_id": "str",\n  "meta_key": "str",\n  "doc_doi": "str",\n  "meta_doi": "str",\n  "doi": "str",\n  "doi_flag": "str",\n  "isbn": "str",\n  "journal": "str",\n  "doc_title": "str",\n  "meta_title": "str",\n  "title": "str",\n  "doc_pub_date": "str",\n  "meta_pub_date": "str",\n  "pub_date": "str",\n  "doc_author": "str",\n  "meta_author": "str",\n  "author": "str",\n  "doc_size": "str",\n  "insert_date": "str",\n  "multi_row_flag": "str"\n}',
            "DATETIME_LIST": '[ \n  "insert_date" \n] ',
            "NULL_STRING_LIST": '[\n  "dkey",\n  "raw_id",\n  "meta_key",\n  "doc_doi",\n  "meta_doi",\n  "doi",\n  "doi_flag",\n  "isbn",\n  "journal",\n  "doc_title",\n  "meta_title",\n  "title",\n  "doc_pub_date",\n  "meta_pub_date",\n  "pub_date",\n  "doc_author",\n  "meta_author",\n  "author",\n  "doc_size",\n  "insert_date",\n  "multi_row_flag"\n]',
    ...
    transform_csv_dump_8 = kubernetes_engine.GKEStartPodOperator(
        ...
        env_vars={
            ...
            "TARGET_GCS_BUCKET": "{{ var.value.composer_bucket }}",
            "CHUNKSIZE": "{{ var.json.the_general_index.chunksize }}",
            "DATASET_ID": "{{ var.json.the_general_index.dump_8.dataset_id }}",
            "TABLE_ID": "{{ var.json.the_general_index.destination_table }}",
            "SCHEMA_PATH": "{{ var.json.the_general_index.schema_path }}",
            "SOURCE_FILE_HEADER_ROWS": "{{ var.json.the_general_index.source_file_header_rows }}",
            "SOURCE_FILE_FOOTER_ROWS": "{{ var.json.the_general_index.source_file_footer_rows }}",
            ...
            "TARGET_FILE": "{{ var.json.the_general_index.dump_8.target_url }}",
            "TARGET_GCS_PATH": "{{ var.json.the_general_index.dump_8.target_path }}",
            "INPUT_CSV_HEADERS": '[\n  "dkey",\n  "raw_id",\n  "meta_key",\n  "doc_doi",\n  "meta_doi",\n  "doi",\n  "doi_flag",\n  "isbn",\n  "journal",\n  "doc_title",\n  "meta_title",\n  "title",\n  "doc_pub_date",\n  "meta_pub_date",\n  "pub_date",\n  "doc_author",\n  "meta_author",\n  "author",\n  "doc_size",\n  "insert_date",\n  "multi_row_flag"\n]',
            "DATA_DTYPES": '{\n  "dkey": "str",\n  "raw_id": "str",\n  "meta_key": "str",\n  "doc_doi": "str",\n  "meta_doi": "str",\n  "doi": "str",\n  "doi_flag": "str",\n  "isbn": "str",\n  "journal": "str",\n  "doc_title": "str",\n  "meta_title": "str",\n  "title": "str",\n  "doc_pub_date": "str",\n  "meta_pub_date": "str",\n  "pub_date": "str",\n  "doc_author": "str",\n  "meta_author": "str",\n  "author": "str",\n  "doc_size": "str",\n  "insert_date": "str",\n  "multi_row_flag": "str"\n}',
            "DATETIME_LIST": '[ \n  "insert_date" \n] ',
            "NULL_STRING_LIST": '[\n  "dkey",\n  "raw_id",\n  "meta_key",\n  "doc_doi",\n  "meta_doi",\n  "doi",\n  "doi_flag",\n  "isbn",\n  "journal",\n  "doc_title",\n  "meta_title",\n  "title",\n  "doc_pub_date",\n  "meta_pub_date",\n  "pub_date",\n  "doc_author",\n  "meta_author",\n  "author",\n  "doc_size",\n  "insert_date",\n  "multi_row_flag"\n]',
    ...
    transform_csv_dump_9 = kubernetes_engine.GKEStartPodOperator(
        ...
        env_vars={
            ...
            "TARGET_GCS_BUCKET": "{{ var.value.composer_bucket }}",
            "CHUNKSIZE": "{{ var.json.the_general_index.chunksize }}",
            "DATASET_ID": "{{ var.json.the_general_index.dump_9.dataset_id }}",
            "TABLE_ID": "{{ var.json.the_general_index.destination_table }}",
            "SCHEMA_PATH": "{{ var.json.the_general_index.schema_path }}",
            "SOURCE_FILE_HEADER_ROWS": "{{ var.json.the_general_index.source_file_header_rows }}",
            "SOURCE_FILE_FOOTER_ROWS": "{{ var.json.the_general_index.source_file_footer_rows }}",
            ...
            "TARGET_FILE": "{{ var.json.the_general_index.dump_9.target_url }}",
            "TARGET_GCS_PATH": "{{ var.json.the_general_index.dump_9.target_path }}",
            "INPUT_CSV_HEADERS": '[\n  "dkey",\n  "raw_id",\n  "meta_key",\n  "doc_doi",\n  "meta_doi",\n  "doi",\n  "doi_flag",\n  "isbn",\n  "journal",\n  "doc_title",\n  "meta_title",\n  "title",\n  "doc_pub_date",\n  "meta_pub_date",\n  "pub_date",\n  "doc_author",\n  "meta_author",\n  "author",\n  "doc_size",\n  "insert_date",\n  "multi_row_flag"\n]',
            "DATA_DTYPES": '{\n  "dkey": "str",\n  "raw_id": "str",\n  "meta_key": "str",\n  "doc_doi": "str",\n  "meta_doi": "str",\n  "doi": "str",\n  "doi_flag": "str",\n  "isbn": "str",\n  "journal": "str",\n  "doc_title": "str",\n  "meta_title": "str",\n  "title": "str",\n  "doc_pub_date": "str",\n  "meta_pub_date": "str",\n  "pub_date": "str",\n  "doc_author": "str",\n  "meta_author": "str",\n  "author": "str",\n  "doc_size": "str",\n  "insert_date": "str",\n  "multi_row_flag": "str"\n}',
            "DATETIME_LIST": '[ \n  "insert_date" \n] ',
            "NULL_STRING_LIST": '[\n  "dkey",\n  "raw_id",\n  "meta_key",\n  "doc_doi",\n  "meta_doi",\n  "doi",\n  "doi_flag",\n  "isbn",\n  "journal",\n  "doc_title",\n  "meta_title",\n  "title",\n  "doc_pub_date",\n  "meta_pub_date",\n  "pub_date",\n  "doc_author",\n  "meta_author",\n  "author",\n  "doc_size",\n  "insert_date",\n  "multi_row_flag"\n]',
    ...
    transform_csv_dump_a = kubernetes_engine.GKEStartPodOperator(
        ...
        env_vars={
            ...
            "TARGET_GCS_BUCKET": "{{ var.value.composer_bucket }}",
            "CHUNKSIZE": "{{ var.json.the_general_index.chunksize }}",
            "DATASET_ID": "{{ var.json.the_general_index.dump_a.dataset_id }}",
            "TABLE_ID": "{{ var.json.the_general_index.destination_table }}",
            "SCHEMA_PATH": "{{ var.json.the_general_index.schema_path }}",
            "SOURCE_FILE_HEADER_ROWS": "{{ var.json.the_general_index.source_file_header_rows }}",
            "SOURCE_FILE_FOOTER_ROWS": "{{ var.json.the_general_index.source_file_footer_rows }}",
            ...
            "TARGET_FILE": "{{ var.json.the_general_index.dump_a.target_url }}",
            "TARGET_GCS_PATH": "{{ var.json.the_general_index.dump_a.target_path }}",
            "INPUT_CSV_HEADERS": '[\n  "dkey",\n  "raw_id",\n  "meta_key",\n  "doc_doi",\n  "meta_doi",\n  "doi",\n  "doi_flag",\n  "isbn",\n  "journal",\n  "doc_title",\n  "meta_title",\n  "title",\n  "doc_pub_date",\n  "meta_pub_date",\n  "pub_date",\n  "doc_author",\n  "meta_author",\n  "author",\n  "doc_size",\n  "insert_date",\n  "multi_row_flag"\n]',
            "DATA_DTYPES": '{\n  "dkey": "str",\n  "raw_id": "str",\n  "meta_key": "str",\n  "doc_doi": "str",\n  "meta_doi": "str",\n  "doi": "str",\n  "doi_flag": "str",\n  "isbn": "str",\n  "journal": "str",\n  "doc_title": "str",\n  "meta_title": "str",\n  "title": "str",\n  "doc_pub_date": "str",\n  "meta_pub_date": "str",\n  "pub_date": "str",\n  "doc_author": "str",\n  "meta_author": "str",\n  "author": "str",\n  "doc_size": "str",\n  "insert_date": "str",\n  "multi_row_flag": "str"\n}',
            "DATETIME_LIST": '[ \n  "insert_date" \n] ',
            "NULL_STRING_LIST": '[\n  "dkey",\n  "raw_id",\n  "meta_key",\n  "doc_doi",\n  "meta_doi",\n  "doi",\n  "doi_flag",\n  "isbn",\n  "journal",\n  "doc_title",\n  "meta_title",\n  "title",\n  "doc_pub_date",\n  "meta_pub_date",\n  "pub_date",\n  "doc_author",\n  "meta_author",\n  "author",\n  "doc_size",\n  "insert_date",\n  "multi_row_flag"\n]',
    ...
    transform_csv_dump_b = kubernetes_engine.GKEStartPodOperator(
        ...
        env_vars={
            ...
            "TARGET_GCS_BUCKET": "{{ var.value.composer_bucket }}",
            "CHUNKSIZE": "{{ var.json.the_general_index.chunksize }}",
            "DATASET_ID": "{{ var.json.the_general_index.dump_b.dataset_id }}",
            "TABLE_ID": "{{ var.json.the_general_index.destination_table }}",
            "SCHEMA_PATH": "{{ var.json.the_general_index.schema_path }}",
            "SOURCE_FILE_HEADER_ROWS": "{{ var.json.the_general_index.source_file_header_rows }}",
            "SOURCE_FILE_FOOTER_ROWS": "{{ var.json.the_general_index.source_file_footer_rows }}",
            ...
            "TARGET_FILE": "{{ var.json.the_general_index.dump_b.target_url }}",
            "TARGET_GCS_PATH": "{{ var.json.the_general_index.dump_b.target_path }}",
            "INPUT_CSV_HEADERS": '[\n  "dkey",\n  "raw_id",\n  "meta_key",\n  "doc_doi",\n  "meta_doi",\n  "doi",\n  "doi_flag",\n  "isbn",\n  "journal",\n  "doc_title",\n  "meta_title",\n  "title",\n  "doc_pub_date",\n  "meta_pub_date",\n  "pub_date",\n  "doc_author",\n  "meta_author",\n  "author",\n  "doc_size",\n  "insert_date",\n  "multi_row_flag"\n]',
            "DATA_DTYPES": '{\n  "dkey": "str",\n  "raw_id": "str",\n  "meta_key": "str",\n  "doc_doi": "str",\n  "meta_doi": "str",\n  "doi": "str",\n  "doi_flag": "str",\n  "isbn": "str",\n  "journal": "str",\n  "doc_title": "str",\n  "meta_title": "str",\n  "title": "str",\n  "doc_pub_date": "str",\n  "meta_pub_date": "str",\n  "pub_date": "str",\n  "doc_author": "str",\n  "meta_author": "str",\n  "author": "str",\n  "doc_size": "str",\n  "insert_date": "str",\n  "multi_row_flag": "str"\n}',
            "DATETIME_LIST": '[ \n  "insert_date" \n] ',
            "NULL_STRING_LIST": '[\n  "dkey",\n  "raw_id",\n  "meta_key",\n  "doc_doi",\n  "meta_doi",\n  "doi",\n  "doi_flag",\n  "isbn",\n  "journal",\n  "doc_title",\n  "meta_title",\n  "title",\n  "doc_pub_date",\n  "meta_pub_date",\n  "pub_date",\n  "doc_author",\n  "meta_author",\n  "author",\n  "doc_size",\n  "insert_date",\n  "multi_row_flag"\n]',
    ...
    transform_csv_dump_c = kubernetes_engine.GKEStartPodOperator(
        ...
        env_vars={
            ...
            "TARGET_GCS_BUCKET": "{{ var.value.composer_bucket }}",
            "CHUNKSIZE": "{{ var.json.the_general_index.chunksize }}",
            "DATASET_ID": "{{ var.json.the_general_index.dump_c.dataset_id }}",
            "TABLE_ID": "{{ var.json.the_general_index.destination_table }}",
            "SCHEMA_PATH": "{{ var.json.the_general_index.schema_path }}",
            "SOURCE_FILE_HEADER_ROWS": "{{ var.json.the_general_index.source_file_header_rows }}",
            "SOURCE_FILE_FOOTER_ROWS": "{{ var.json.the_general_index.source_file_footer_rows }}",
            ...
            "TARGET_FILE": "{{ var.json.the_general_index.dump_c.target_url }}",
            "TARGET_GCS_PATH": "{{ var.json.the_general_index.dump_c.target_path }}",
            "INPUT_CSV_HEADERS": '[\n  "dkey",\n  "raw_id",\n  "meta_key",\n  "doc_doi",\n  "meta_doi",\n  "doi",\n  "doi_flag",\n  "isbn",\n  "journal",\n  "doc_title",\n  "meta_title",\n  "title",\n  "doc_pub_date",\n  "meta_pub_date",\n  "pub_date",\n  "doc_author",\n  "meta_author",\n  "author",\n  "doc_size",\n  "insert_date",\n  "multi_row_flag"\n]',
            "DATA_DTYPES": '{\n  "dkey": "str",\n  "raw_id": "str",\n  "meta_key": "str",\n  "doc_doi": "str",\n  "meta_doi": "str",\n  "doi": "str",\n  "doi_flag": "str",\n  "isbn": "str",\n  "journal": "str",\n  "doc_title": "str",\n  "meta_title": "str",\n  "title": "str",\n  "doc_pub_date": "str",\n  "meta_pub_date": "str",\n  "pub_date": "str",\n  "doc_author": "str",\n  "meta_author": "str",\n  "author": "str",\n  "doc_size": "str",\n  "insert_date": "str",\n  "multi_row_flag": "str"\n}',
            "DATETIME_LIST": '[ \n  "insert_date" \n] ',
            "NULL_STRING_LIST": '[\n  "dkey",\n  "raw_id",\n  "meta_key",\n  "doc_doi",\n  "meta_doi",\n  "doi",\n  "doi_flag",\n  "isbn",\n  "journal",\n  "doc_title",\n  "meta_title",\n  "title",\n  "doc_pub_date",\n  "meta_pub_date",\n  "pub_date",\n  "doc_author",\n  "meta_author",\n  "author",\n  "doc_size",\n  "insert_date",\n  "multi_row_flag"\n]',
    ...
    transform_csv_dump_d = kubernetes_engine.GKEStartPodOperator(
        ...
        env_vars={
            ...
            "TARGET_GCS_BUCKET": "{{ var.value.composer_bucket }}",
            "CHUNKSIZE": "{{ var.json.the_general_index.chunksize }}",
            "DATASET_ID": "{{ var.json.the_general_index.dump_d.dataset_id }}",
            "TABLE_ID": "{{ var.json.the_general_index.destination_table }}",
            "SCHEMA_PATH": "{{ var.json.the_general_index.schema_path }}",
            "SOURCE_FILE_HEADER_ROWS": "{{ var.json.the_general_index.source_file_header_rows }}",
            "SOURCE_FILE_FOOTER_ROWS": "{{ var.json.the_general_index.source_file_footer_rows }}",
            ...
            "TARGET_FILE": "{{ var.json.the_general_index.dump_d.target_url }}",
            "TARGET_GCS_PATH": "{{ var.json.the_general_index.dump_d.target_path }}",
            "INPUT_CSV_HEADERS": '[\n  "dkey",\n  "raw_id",\n  "meta_key",\n  "doc_doi",\n  "meta_doi",\n  "doi",\n  "doi_flag",\n  "isbn",\n  "journal",\n  "doc_title",\n  "meta_title",\n  "title",\n  "doc_pub_date",\n  "meta_pub_date",\n  "pub_date",\n  "doc_author",\n  "meta_author",\n  "author",\n  "doc_size",\n  "insert_date",\n  "multi_row_flag"\n]',
            "DATA_DTYPES": '{\n  "dkey": "str",\n  "raw_id": "str",\n  "meta_key": "str",\n  "doc_doi": "str",\n  "meta_doi": "str",\n  "doi": "str",\n  "doi_flag": "str",\n  "isbn": "str",\n  "journal": "str",\n  "doc_title": "str",\n  "meta_title": "str",\n  "title": "str",\n  "doc_pub_date": "str",\n  "meta_pub_date": "str",\n  "pub_date": "str",\n  "doc_author": "str",\n  "meta_author": "str",\n  "author": "str",\n  "doc_size": "str",\n  "insert_date": "str",\n  "multi_row_flag": "str"\n}',
            "DATETIME_LIST": '[ \n  "insert_date" \n] ',
            "NULL_STRING_LIST": '[\n  "dkey",\n  "raw_id",\n  "meta_key",\n  "doc_doi",\n  "meta_doi",\n  "doi",\n  "doi_flag",\n  "isbn",\n  "journal",\n  "doc_title",\n  "meta_title",\n  "title",\n  "doc_pub_date",\n  "meta_pub_date",\n  "pub_date",\n  "doc_author",\n  "meta_author",\n  "author",\n  "doc_size",\n  "insert_date",\n  "multi_row_flag"\n]',
    ...
    transform_csv_dump_e = kubernetes_engine.GKEStartPodOperator(
        ...
        env_vars={
            ...
            "TARGET_GCS_BUCKET": "{{ var.value.composer_bucket }}",
            "CHUNKSIZE": "{{ var.json.the_general_index.chunksize }}",
            "DATASET_ID": "{{ var.json.the_general_index.dump_e.dataset_id }}",
            "TABLE_ID": "{{ var.json.the_general_index.destination_table }}",
            "SCHEMA_PATH": "{{ var.json.the_general_index.schema_path }}",
            "SOURCE_FILE_HEADER_ROWS": "{{ var.json.the_general_index.source_file_header_rows }}",
            "SOURCE_FILE_FOOTER_ROWS": "{{ var.json.the_general_index.source_file_footer_rows }}",
            ...
            "TARGET_FILE": "{{ var.json.the_general_index.dump_e.target_url }}",
            "TARGET_GCS_PATH": "{{ var.json.the_general_index.dump_e.target_path }}",
            "INPUT_CSV_HEADERS": '[\n  "dkey",\n  "raw_id",\n  "meta_key",\n  "doc_doi",\n  "meta_doi",\n  "doi",\n  "doi_flag",\n  "isbn",\n  "journal",\n  "doc_title",\n  "meta_title",\n  "title",\n  "doc_pub_date",\n  "meta_pub_date",\n  "pub_date",\n  "doc_author",\n  "meta_author",\n  "author",\n  "doc_size",\n  "insert_date",\n  "multi_row_flag"\n]',
            "DATA_DTYPES": '{\n  "dkey": "str",\n  "raw_id": "str",\n  "meta_key": "str",\n  "doc_doi": "str",\n  "meta_doi": "str",\n  "doi": "str",\n  "doi_flag": "str",\n  "isbn": "str",\n  "journal": "str",\n  "doc_title": "str",\n  "meta_title": "str",\n  "title": "str",\n  "doc_pub_date": "str",\n  "meta_pub_date": "str",\n  "pub_date": "str",\n  "doc_author": "str",\n  "meta_author": "str",\n  "author": "str",\n  "doc_size": "str",\n  "insert_date": "str",\n  "multi_row_flag": "str"\n}',
            "DATETIME_LIST": '[ \n  "insert_date" \n] ',
            "NULL_STRING_LIST": '[\n  "dkey",\n  "raw_id",\n  "meta_key",\n  "doc_doi",\n  "meta_doi",\n  "doi",\n  "doi_flag",\n  "isbn",\n  "journal",\n  "doc_title",\n  "meta_title",\n  "title",\n  "doc_pub_date",\n  "meta_pub_date",\n  "pub_date",\n  "doc_author",\n  "meta_author",\n  "author",\n  "doc_size",\n  "insert_date",\n  "multi_row_flag"\n]',
    ...
    transform_csv_dump_f = kubernetes_engine.GKEStartPodOperator(
        ...
        env_vars={
            ...
            "TARGET_GCS_BUCKET": "{{ var.value.composer_bucket }}",
            "CHUNKSIZE": "{{ var.json.the_general_index.chunksize }}",
            "DATASET_ID": "{{ var.json.the_general_index.dump_f.dataset_id }}",
            "TABLE_ID": "{{ var.json.the_general_index.destination_table }}",
            "SCHEMA_PATH": "{{ var.json.the_general_index.schema_path }}",
            "SOURCE_FILE_HEADER_ROWS": "{{ var.json.the_general_index.source_file_header_rows }}",
            "SOURCE_FILE_FOOTER_ROWS": "{{ var.json.the_general_index.source_file_footer_rows }}",
            ...
            "TARGET_FILE": "{{ var.json.the_general_index.dump_f.target_url }}",
            "TARGET_GCS_PATH": "{{ var.json.the_general_index.dump_f.target_path }}",
            "INPUT_CSV_HEADERS": '[\n  "dkey",\n  "raw_id",\n  "meta_key",\n  "doc_doi",\n  "meta_doi",\n  "doi",\n  "doi_flag",\n  "isbn",\n  "journal",\n  "doc_title",\n  "meta_title",\n  "title",\n  "doc_pub_date",\n  "meta_pub_date",\n  "pub_date",\n  "doc_author",\n  "meta_author",\n  "author",\n  "doc_size",\n  "insert_date",\n  "multi_row_flag"\n]',
            "DATA_DTYPES": '{\n  "dkey": "str",\n  "raw_id": "str",\n  "meta_key": "str",\n  "doc_doi": "str",\n  "meta_doi": "str",\n  "doi": "str",\n  "doi_flag": "str",\n  "isbn": "str",\n  "journal": "str",\n  "doc_title": "str",\n  "meta_title": "str",\n  "title": "str",\n  "doc_pub_date": "str",\n  "meta_pub_date": "str",\n  "pub_date": "str",\n  "doc_author": "str",\n  "meta_author": "str",\n  "author": "str",\n  "doc_size": "str",\n  "insert_date": "str",\n  "multi_row_flag": "str"\n}',
            "DATETIME_LIST": '[ \n  "insert_date" \n] ',
            "NULL_STRING_LIST": '[\n  "dkey",\n  "raw_id",\n  "meta_key",\n  "doc_doi",\n  "meta_doi",\n  "doi",\n  "doi_flag",\n  "isbn",\n  "journal",\n  "doc_title",\n  "meta_title",\n  "title",\n  "doc_pub_date",\n  "meta_pub_date",\n  "pub_date",\n  "doc_author",\n  "meta_author",\n  "author",\n  "doc_size",\n  "insert_date",\n  "multi_row_flag"\n]',
