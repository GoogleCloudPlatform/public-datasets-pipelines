...
with DAG(
    dag_id="covid19_jhu_csse_eu.deaths",
    ...
    transform_csv = kubernetes_pod.KubernetesPodOperator(
        ...
        env_vars={
            "SOURCE_URL": "https://raw.githubusercontent.com/CSSEGISandData/COVID-19/master/csse_covid_19_data/csse_covid_19_time_series/time_series_covid19_deaths_global.csv",
            "SOURCE_FILE": "files/data.csv",
            "TARGET_FILE": "files/data_output.csv",
            "CHUNKSIZE": "1000000",
            "TARGET_GCS_BUCKET": "{{ var.value.composer_bucket }}",
            "TARGET_GCS_PATH": "data/covid19_jhu_csse_eu/deaths/data_output.csv",
            "PIPELINE_NAME": "deaths",
    ...
    load_to_bq = gcs_to_bigquery.GCSToBigQueryOperator(
        ...
        source_objects=["data/covid19_jhu_csse_eu/deaths/data_output.csv"],
        source_format="CSV",
        destination_project_dataset_table="covid19_jhu_csse_eu.deaths",
        skip_leading_rows=1,
