...
with DAG(
    ...
    transform_csv = kubernetes_pod_operator.KubernetesPodOperator(
        ...
        env_vars={'SOURCE_URL': 'https://data.austintexas.gov/api/views/tyfh-5r8s/rows.csv', 'SOURCE_FILE': 'files/data.csv', 'TARGET_FILE': 'files/data_output.csv', 'CHUNKSIZE': '500000', 'TARGET_GCS_BUCKET': '{{ var.value.composer_bucket }}', 'TARGET_GCS_PATH': 'data/austin/bikeshare_trips/data_output.csv'},
