...
resource "google_bigquery_table" "covid19_google_mobility_eu_mobility_report" {
  ...
  depends_on = [
    google_bigquery_dataset.covid19_google_mobility_eu
  ]
}

output "bigquery_table-covid19_google_mobility_eu_mobility_report-table_id" {
  value = google_bigquery_table.covid19_google_mobility_eu_mobility_report.table_id
}

output "bigquery_table-covid19_google_mobility_eu_mobility_report-id" {
  value = google_bigquery_table.covid19_google_mobility_eu_mobility_report.id
}
