...
with DAG(
    dag_id="covid19_google_mobility_eu.mobility_report",
    ...
    mobility_report_transform_csv = kubernetes_pod_operator.KubernetesPodOperator(
        ...
        image="{{ var.json.covid19_google_mobility_eu.container_registry.run_csv_transform_kub }}",
        env_vars={
            "SOURCE_URL": "https://www.gstatic.com/covid19/mobility/Global_Mobility_Report.csv",
            "SOURCE_FILE": "files/data.csv",
            "TARGET_FILE": "files/data_output.csv",
            "TARGET_GCS_BUCKET": "{{ var.value.composer_bucket }}",
            "TARGET_GCS_PATH": "data/covid19_google_mobility_eu/mobility_report/data_output.csv",
            "CHUNK_SIZE": "200",
    ...
    load_mobility_report_to_bq = gcs_to_bq.GoogleCloudStorageToBigQueryOperator(
        ...
        source_objects=[
            "data/covid19_google_mobility_eu/mobility_report/data_output.csv"
        ],
        source_format="CSV",
        destination_project_dataset_table="covid19_google_mobility_eu.mobility_report",
        skip_leading_rows=1,
