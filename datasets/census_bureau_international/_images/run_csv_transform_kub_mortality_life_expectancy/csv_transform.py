...
def main(
    ...
    logging.info(f"International Database (Life Expectancy - Country Names) process started")

    pathlib.Path("./files").mkdir(parents=True, exist_ok=True)

    df_life_exp = obtain_source_data(source_url, source_file, ['country_code', 'year'], "_life_exp_data.csv", 0, ",")
    df_country = obtain_source_data(source_url, source_file, ["country_code"], "_country_data.csv", 1, ",")
    ...
    logging.info("International Database (Life Expectancy - Country Names) process completed")
