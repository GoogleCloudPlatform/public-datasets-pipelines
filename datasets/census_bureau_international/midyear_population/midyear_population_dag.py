...
with DAG(
    ...
    midyear_population_transform_csv = kubernetes_pod_operator.KubernetesPodOperator(
        task_id="midyear_population_transform_csv",
        ...
        env_vars={
            "SOURCE_URL": '["gs://pdp-feeds-staging/Census/idbzip/IDBext001.csv","gs://pdp-feeds-staging/Census/idbzip/IDBextCTYS.csv"]',
            ...
            "PIPELINE_NAME": "midyear_population",
            "FILE_PATH": "files/",
            "CSV_HEADERS": '["country_code","country_name","year","midyear_population"]',
        },
        resources={"request_memory": "4G", "request_cpu": "1"},
    )

    # Task to load CSV data to a BigQuery table
    load_midyear_population_to_bq = gcs_to_bq.GoogleCloudStorageToBigQueryOperator(
        task_id="load_midyear_population_to_bq",
    ...
    midyear_population_transform_csv >> load_midyear_population_to_bq
