...
with DAG(
    dag_id="libraries_io.repositories",
    ...
    load_repositories_to_bq = gcs_to_bigquery.GCSToBigQueryOperator(
    ...
    # Task to load CSV data to a BigQuery table
    load_repositories_to_bq_2 = gcs_to_bigquery.GCSToBigQueryOperator(
    ...
    # Task to load CSV data to a BigQuery table
    load_repositories_to_bq_3 = gcs_to_bigquery.GCSToBigQueryOperator(
