...
with DAG(
    dag_id="covid19_jhu_csse.deaths",
    ...
    transform_csv = kubernetes_pod.KubernetesPodOperator(
        ...
        env_vars={
            ...
            "TARGET_GCS_PATH": "data/covid19_jhu_csse/deaths/data_output.csv",
    ...
    load_to_bq = gcs_to_bigquery.GCSToBigQueryOperator(
        ...
        source_objects=["data/covid19_jhu_csse/deaths/data_output.csv"],
        source_format="CSV",
        destination_project_dataset_table="covid19_jhu_csse.deaths",
        skip_leading_rows=1,
