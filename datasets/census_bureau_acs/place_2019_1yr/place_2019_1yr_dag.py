...
with DAG(
    dag_id="census_bureau_acs.place_2019_1yr",
    ...
    place_2019_1yr_transform_csv = kubernetes_pod_operator.KubernetesPodOperator(
        ...
        env_vars={
            ...
            "TARGET_GCS_PATH": "data/census_bureau_acs/place_2019_1yr/data_output.csv",
    ...
    load_place_2019_1yr_to_bq = gcs_to_bq.GoogleCloudStorageToBigQueryOperator(
        ...
        source_objects=["data/census_bureau_acs/place_2019_1yr/data_output.csv"],
        source_format="CSV",
        destination_project_dataset_table="census_bureau_acs.place_2019_1yr",
        skip_leading_rows=1,
