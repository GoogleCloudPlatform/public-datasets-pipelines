...
with DAG(
    dag_id="census_bureau_acs.puma_2019_5yr",
    ...
    puma_2019_5yr_transform_csv = kubernetes_pod_operator.KubernetesPodOperator(
        ...
        env_vars={
            ...
            "TARGET_GCS_PATH": "data/census_bureau_acs/puma_2019_5yr/data_output.csv",
            "PIPELINE_NAME": "puma_2019_5yr",
            "GEOGRAPHY": "puma",
            "REPORT_LEVEL": "national_level",
            "CONCAT_COL": '["state","public_use_microdata_area"]',
            "RENAME_MAPPINGS": '{"0":"name", "1":"KPI_Value", "2":"state", "3":"public_use_microdata_area"}',
    ...
    load_puma_2019_5yr_to_bq = gcs_to_bq.GoogleCloudStorageToBigQueryOperator(
        ...
        source_objects=["data/census_bureau_acs/puma_2019_5yr/data_output.csv"],
        source_format="CSV",
        destination_project_dataset_table="census_bureau_acs.puma_2019_5yr",
        skip_leading_rows=1,
