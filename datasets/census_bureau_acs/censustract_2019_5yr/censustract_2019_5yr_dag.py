...
with DAG(
    dag_id="census_bureau_acs.censustract_2019_5yr",
    ...
    censustract_2019_5yr_transform_csv = kubernetes_pod_operator.KubernetesPodOperator(
        task_id="censustract_2019_5yr_transform_csv",
        startup_timeout_seconds=600,
        name="censustract_2019_5yr",
        namespace="default",
        affinity={
            "nodeAffinity": {
        ...
        env_vars={
            ...
            "TARGET_GCS_PATH": "data/census_bureau_acs/censustract_2019_5yr/data_output.csv",
            "PIPELINE_NAME": "censustract_2019_5yr",
            "GEOGRAPHY": "censustract",
            "REPORT_LEVEL": "state_level",
            "CONCAT_COL": '["state","county","tract"]',
            "RENAME_MAPPINGS": '{"0":"name", "1":"KPI_Value", "2":"state", "3":"county","4":"tract"}',
    ...
    load_censustract_2019_5yr_to_bq = gcs_to_bq.GoogleCloudStorageToBigQueryOperator(
        task_id="load_censustract_2019_5yr_to_bq",
        bucket="{{ var.value.composer_bucket }}",
        source_objects=["data/census_bureau_acs/censustract_2019_5yr/data_output.csv"],
        source_format="CSV",
        destination_project_dataset_table="census_bureau_acs.censustract_2019_5yr",
        skip_leading_rows=1,
    ...
    censustract_2019_5yr_transform_csv >> load_censustract_2019_5yr_to_bq
