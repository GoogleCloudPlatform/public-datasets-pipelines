...
with DAG(
    dag_id="census_bureau_acs.county_2019_1yr",
    ...
    county_2019_1yr_transform_csv = kubernetes_pod_operator.KubernetesPodOperator(
        ...
        env_vars={
            ...
            "TARGET_GCS_PATH": "data/census_bureau_acs/county_2019_1yr/data_output.csv",
            "PIPELINE_NAME": "county_2019_1yr",
            "GEOGRAPHY": "county",
            "REPORT_LEVEL": "national_level",
            "CONCAT_COL": '["state","county"]',
            "RENAME_MAPPINGS": '{"0":"name", "1":"KPI_Value", "2":"state", "3":"county"}',
    ...
    load_county_2019_1yr_to_bq = gcs_to_bq.GoogleCloudStorageToBigQueryOperator(
        ...
        source_objects=["data/census_bureau_acs/county_2019_1yr/data_output.csv"],
        source_format="CSV",
        destination_project_dataset_table="census_bureau_acs.county_2019_1yr",
        skip_leading_rows=1,
