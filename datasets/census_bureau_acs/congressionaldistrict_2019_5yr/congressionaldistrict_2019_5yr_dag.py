...
with DAG(
    dag_id="census_bureau_acs.congressionaldistrict_2019_5yr",
    ...
    congressionaldistrict_2019_5yr_transform_csv = kubernetes_pod_operator.KubernetesPodOperator(
        task_id="congressionaldistrict_2019_5yr_transform_csv",
        startup_timeout_seconds=600,
        name="congressionaldistrict_2019_5yr",
        namespace="default",
        affinity={
            "nodeAffinity": {
        ...
        env_vars={
            "SOURCE_URL": "https://api.census.gov/data/2019/acs/acs+year_report+?get=NAME,+key[0:-3]+_+key[-3:]+E&for=+api_naming_convention+:*&in=state:*&key=550e53635053be51754b09b5e9f5009c94aa0586",
            "YEAR_REPORT": "5",
            "API_NAMING_CONVENTION": "congressional%20district",
            "TARGET_FILE": "files/data_output.csv",
            "TARGET_GCS_BUCKET": "{{ var.value.composer_bucket }}",
            "TARGET_GCS_PATH": "data/census_bureau_acs/congressionaldistrict_2019_5yr/data_output.csv",
            "PIPELINE_NAME": "congressionaldistrict_2019_5yr",
            "GEOGRAPHY": "congressionaldistrict",
            "REPORT_LEVEL": "national_level",
            "CONCAT_COL": '["state","congressional_district"]',
            "RENAME_MAPPINGS": '{"0":"name", "1":"KPI_Value", "2":"state", "3":"congressional_district"}',
    ...
    load_congressionaldistrict_2019_5yr_to_bq = gcs_to_bq.GoogleCloudStorageToBigQueryOperator(
        task_id="load_congressionaldistrict_2019_5yr_to_bq",
        bucket="{{ var.value.composer_bucket }}",
        source_objects=[
            "data/census_bureau_acs/congressionaldistrict_2019_5yr/data_output.csv"
        ],
        source_format="CSV",
        destination_project_dataset_table="census_bureau_acs.congressionaldistrict_2019_5yr",
        skip_leading_rows=1,
    ...
    congressionaldistrict_2019_5yr_transform_csv >> load_congressionaldistrict_2019_5yr_to_bq
