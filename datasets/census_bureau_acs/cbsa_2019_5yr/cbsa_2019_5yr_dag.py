...
with DAG(
    dag_id="census_bureau_acs.cbsa_2019_5yr",
    ...
    cbsa_2019_5yr_transform_csv = kubernetes_pod_operator.KubernetesPodOperator(
        ...
        env_vars={
            ...
            "TARGET_GCS_PATH": "data/census_bureau_acs/cbsa_2019_5yr/data_output.csv",
    ...
    load_cbsa_2019_5yr_to_bq = gcs_to_bq.GoogleCloudStorageToBigQueryOperator(
        ...
        source_objects=["data/census_bureau_acs/cbsa_2019_5yr/data_output.csv"],
        source_format="CSV",
        destination_project_dataset_table="census_bureau_acs.cbsa_2019_5yr",
        skip_leading_rows=1,
