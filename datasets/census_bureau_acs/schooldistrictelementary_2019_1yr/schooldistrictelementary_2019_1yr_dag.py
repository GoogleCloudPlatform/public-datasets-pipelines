...
with DAG(
    dag_id="census_bureau_acs.schooldistrictelementary_2019_1yr",
    ...
    schooldistrictelementary_2019_1yr_transform_csv = kubernetes_pod_operator.KubernetesPodOperator(
        task_id="schooldistrictelementary_2019_1yr_transform_csv",
        startup_timeout_seconds=600,
        name="schooldistrictelementary_2019_1yr",
        namespace="default",
        affinity={
            "nodeAffinity": {
        ...
        env_vars={
            "SOURCE_URL": "https://api.census.gov/data/2019/acs/acs+year_report+?get=NAME,+key[0:-3]+_+key[-3:]+E&for=+api_naming_convention+:*&in=state:+sc+&key=550e53635053be51754b09b5e9f5009c94aa0586",
            "YEAR_REPORT": "1",
            "API_NAMING_CONVENTION": "school%20district%20(elementary)",
            "TARGET_FILE": "files/data_output.csv",
            "TARGET_GCS_BUCKET": "{{ var.value.composer_bucket }}",
            "TARGET_GCS_PATH": "data/census_bureau_acs/schooldistrictelementary_2019_1yr/data_output.csv",
    ...
    load_schooldistrictelementary_2019_1yr_to_bq = gcs_to_bq.GoogleCloudStorageToBigQueryOperator(
        task_id="load_schooldistrictelementary_2019_1yr_to_bq",
        bucket="{{ var.value.composer_bucket }}",
        source_objects=[
            "data/census_bureau_acs/schooldistrictelementary_2019_1yr/data_output.csv"
        ],
        source_format="CSV",
        destination_project_dataset_table="census_bureau_acs.schooldistrictelementary_2019_1yr",
        skip_leading_rows=1,
    ...
    schooldistrictelementary_2019_1yr_transform_csv >> load_schooldistrictelementary_2019_1yr_to_bq
