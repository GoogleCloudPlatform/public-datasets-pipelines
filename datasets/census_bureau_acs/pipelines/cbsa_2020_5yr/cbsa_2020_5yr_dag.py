...
with DAG(
    dag_id="census_bureau_acs.cbsa_2020_5yr",
    ...
    cbsa_2020_5yr_transform_csv = kubernetes_pod.KubernetesPodOperator(
        task_id="cbsa_2020_5yr_transform_csv",
        ...
        env_vars={
            "SOURCE_URL": "https://api.census.gov/data/2020/acs/acs~year_report~?get=NAME,~group_id~_~row_position~E&for=~api_naming_convention~:*&key=550e53635053be51754b09b5e9f5009c94aa0586",
            "YEAR_REPORT": "5",
            "API_NAMING_CONVENTION": "metropolitan%20statistical%20area/micropolitan%20statistical%20area",
            "TARGET_FILE": "files/data_output.csv",
            "TARGET_GCS_BUCKET": "{{ var.value.composer_bucket }}",
            "TARGET_GCS_PATH": "data/census_bureau_acs/cbsa_2020_5yr/data_output.csv",
    ...
    load_cbsa_2020_5yr_to_bq = gcs_to_bigquery.GCSToBigQueryOperator(
        task_id="load_cbsa_2020_5yr_to_bq",
        bucket="{{ var.value.composer_bucket }}",
        source_objects=["data/census_bureau_acs/cbsa_2020_5yr/data_output.csv"],
        source_format="CSV",
        destination_project_dataset_table="census_bureau_acs.cbsa_2020_5yr",
        skip_leading_rows=1,
    ...
    cbsa_2020_5yr_transform_csv >> load_cbsa_2020_5yr_to_bq
