...
with DAG(
    dag_id="census_bureau_acs.congressionaldistrict_2019_1yr",
    ...
    transform_csv = kubernetes_pod.KubernetesPodOperator(
        ...
        env_vars={
            ...
            "TARGET_GCS_PATH": "data/census_bureau_acs/congressionaldistrict_2019_1yr/data_output.csv",
    ...
    load_to_bq = gcs_to_bigquery.GCSToBigQueryOperator(
        ...
        source_format="CSV",
        destination_project_dataset_table="census_bureau_acs.congressionaldistrict_2019_1yr",
        skip_leading_rows=1,
