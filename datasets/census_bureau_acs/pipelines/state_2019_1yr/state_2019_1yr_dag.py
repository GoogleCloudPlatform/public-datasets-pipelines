...
with DAG(
    dag_id="census_bureau_acs.state_2019_1yr",
    ...
    state_2019_1yr_transform_csv = kubernetes_pod.KubernetesPodOperator(
        ...
        env_vars={
            ...
            "TARGET_GCS_PATH": "data/census_bureau_acs/state_2019_1yr/data_output.csv",
    ...
    load_state_2019_1yr_to_bq = gcs_to_bigquery.GCSToBigQueryOperator(
        task_id="load_state_2019_1yr_to_bq",
        bucket="{{ var.value.composer_bucket }}",
        source_objects=["data/census_bureau_acs/state_2019_1yr/data_output.csv"],
        source_format="CSV",
        destination_project_dataset_table="census_bureau_acs.state_2019_1yr",
        skip_leading_rows=1,
