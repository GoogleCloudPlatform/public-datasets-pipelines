...
with DAG(
    dag_id="census_bureau_acs.schooldistrictunified_2019_5yr",
    ...
    schooldistrictunified_2019_5yr_transform_csv = kubernetes_pod_operator.KubernetesPodOperator(
        task_id="schooldistrictunified_2019_5yr_transform_csv",
        startup_timeout_seconds=600,
        name="schooldistrictunified_2019_5yr",
        namespace="default",
        affinity={
            "nodeAffinity": {
        ...
        env_vars={
            ...
            "TARGET_GCS_PATH": "data/census_bureau_acs/schooldistrictunified_2019_5yr/data_output.csv",
    ...
    load_schooldistrictunified_2019_5yr_to_bq = gcs_to_bq.GoogleCloudStorageToBigQueryOperator(
        task_id="load_schooldistrictunified_2019_5yr_to_bq",
        bucket="{{ var.value.composer_bucket }}",
        source_objects=[
            "data/census_bureau_acs/schooldistrictunified_2019_5yr/data_output.csv"
        ],
        source_format="CSV",
        destination_project_dataset_table="census_bureau_acs.schooldistrictunified_2019_5yr",
        skip_leading_rows=1,
    ...
    schooldistrictunified_2019_5yr_transform_csv >> load_schooldistrictunified_2019_5yr_to_bq
