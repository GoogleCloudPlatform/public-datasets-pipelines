...
with DAG(
    ...
    sf_311_service_requests = kubernetes_engine.GKEStartPodOperator(
        ...
        project_id="{{ var.value.gcp_project }}",
        location="us-central1-c",
        cluster_name="pdp-san-francisco",
    ...
    sf_muni_routes = kubernetes_engine.GKEStartPodOperator(
    ...
    sf_muni_shapes = kubernetes_engine.GKEStartPodOperator(
    ...
    sf_muni_stops = kubernetes_engine.GKEStartPodOperator(
    ...
    sf_muni_stop_times = kubernetes_engine.GKEStartPodOperator(
        ...
        env_vars={
            ...
            "SCHEMA_PATH": "data/san_francisco/schema/sf_muni_stop_times_schema.json",
    ...
    sf_muni_fares = kubernetes_engine.GKEStartPodOperator(
    ...
    sf_muni_trips = kubernetes_engine.GKEStartPodOperator(
    ...
    sfpd_incidents = kubernetes_engine.GKEStartPodOperator(
    ...
    sf_bikeshare_stations = kubernetes_engine.GKEStartPodOperator(
        ...
        env_vars={
            ...
            "SOURCE_URL": "https://data.sfgov.org/api/views/7jbp-yzp3/rows.csv",
            "CHUNKSIZE": "750000",
            ...
            "HEADER_ROW_ORDINAL": "0",
            "INPUT_CSV_HEADERS": '[\n  "Station ID",\n  "Station Name",\n  "Station ID DOMO",\n  "Has Kiosk",\n  "Dock Count",\n  "Station Latitude",\n  "Station Longitude",\n  "Region_ID",\n  "shape"\n]',
            "DATA_DTYPES": '{\n  "Station ID": "str",\n  "Station Name":"str",\n  "Station ID DOMO": "str",\n  "Has Kiosk": "str",\n  "Dock Count": "str",\n  "Station Latitude": "str",\n  "Station Longitude": "str",\n  "Region_ID": "str",\n  "shape": "str"\n}',
            "RENAME_HEADERS_LIST": '{\n  "Station ID": "station_id",\n  "Station Name": "name",\n  "Station ID DOMO": "short_name",\n  "Station Latitude": "lat",\n  "Station Longitude": "lon",\n  "Region_ID": "region_id",\n  "Dock Count": "capacity",\n  "Has Kiosk": "has_kiosk",\n  "shape": "station_geom"\n}',
            "EMPTY_KEY_LIST": '[\n  "station_id",\n  "name",\n  "lat",\n  "lon"\n]',
    ...
    sf_bikeshare_trips = kubernetes_engine.GKEStartPodOperator(
        ...
        env_vars={
            ...
            "DATE_FORMAT_LIST": '{\n  "start_date_trip_data": "%m/%d/%Y %H:%M",\n  "end_date_trip_data": "%m/%d/%Y %H:%M",\n  "start_date_tripdata": "%Y-%m-%d %H:%M:%S",\n  "end_date_tripdata": "%Y-%m-%d %H:%M:%S"\n}',
