...
with DAG(
    ...
    load_to_bq = gcs_to_bigquery.GCSToBigQueryOperator(
        ...
        source_objects=[
            "{{ var.json.census_opportunity_atlas.container_registry.tract_outcomes.target_gcs_path }}"
        ],
        schema_object="data/census_opportunity_atlas/tract_outcomes/schema.json",
        source_format="CSV",
        destination_project_dataset_table="{{ var.json.census_opportunity_atlas.container_registry.tract_outcomes.destination_table }}",
        skip_leading_rows=1,
