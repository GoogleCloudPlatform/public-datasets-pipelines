...
with DAG(
    dag_id="cms_medicare.outpatient_charges_2012",
    ...
    cms_medicare_outpatient_charges_2012_transform_csv = kubernetes_pod_operator.KubernetesPodOperator(
        task_id="cms_medicare_outpatient_charges_2012_transform_csv",
    ...
    load_cms_medicare_outpatient_charges_2012_to_bq = gcs_to_bq.GoogleCloudStorageToBigQueryOperator(
        task_id="load_cms_medicare_outpatient_charges_2012_to_bq",
    ...
    cms_medicare_outpatient_charges_2012_transform_csv >> load_cms_medicare_outpatient_charges_2012_to_bq
