...
with DAG(
    dag_id="cms_medicare.inpatient_charges_2015",
    ...
    cms_medicare_inpatient_charges_2015_transform_csv = kubernetes_pod_operator.KubernetesPodOperator(
        task_id="cms_medicare_inpatient_charges_2015_transform_csv",
    ...
    load_cms_medicare_inpatient_charges_2015_to_bq = gcs_to_bq.GoogleCloudStorageToBigQueryOperator(
        task_id="load_cms_medicare_inpatient_charges_2015_to_bq",
    ...
    cms_medicare_inpatient_charges_2015_transform_csv >> load_cms_medicare_inpatient_charges_2015_to_bq
