...
with DAG(
    dag_id="cms_medicare.outpatient_charges_2013",
    ...
    cms_medicare_outpatient_charges_2013_transform_csv = kubernetes_pod_operator.KubernetesPodOperator(
        task_id="cms_medicare_outpatient_charges_2013_transform_csv",
    ...
    load_cms_medicare_outpatient_charges_2013_to_bq = gcs_to_bq.GoogleCloudStorageToBigQueryOperator(
        task_id="load_cms_medicare_outpatient_charges_2013_to_bq",
    ...
    cms_medicare_outpatient_charges_2013_transform_csv >> load_cms_medicare_outpatient_charges_2013_to_bq
