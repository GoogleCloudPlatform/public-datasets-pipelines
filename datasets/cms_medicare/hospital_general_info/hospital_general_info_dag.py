...
with DAG(
    dag_id="cms_medicare.hospital_general_info",
    ...
    load_hospital_info_to_bq = gcs_to_bigquery.GCSToBigQueryOperator(
        ...
        schema_fields=[
            ...
            {"name": "hospital_ownership", "type": "STRING", "mode": "NULLABLE"},
            {"name": "emergency_services", "type": "BOOLEAN", "mode": "NULLABLE"},
            {
                "name": "meets_criteria_for_promoting_interoperability_of_ehrs",
                "type": "BOOLEAN",
                "mode": "NULLABLE",
            },
            {"name": "hospital_overall_rating", "type": "STRING", "mode": "NULLABLE"},
            {
