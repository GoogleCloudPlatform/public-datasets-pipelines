...
with DAG(
    ...
    # Run CSV transform within kubernetes pod
    sentinel_2_index_int_test = kubernetes_engine.GKEStartPodOperator(
        task_id="sentinel_2_index_int_test",
        name="sentinel_2_index_int_test",
        project_id="{{ var.value.gcp_project }}",
        location="us-central1-c",
        cluster_name="cloud-storage-geo-index",
        namespace="default",
    ...
    (
        create_cluster
        >> sentinel_2_index_int_test
        >> [landsat_index, sentinel_2_index]
        >> delete_cluster
    )
