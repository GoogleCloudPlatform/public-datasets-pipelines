...
with DAG(
    ...
    download_raw_csv_file = BashOperator(
    ...
    process_raw_csv_file = BashOperator(
    ...
    load_csv_file_to_bq_table = GoogleCloudStorageToBigQueryOperator(
    ...
    archive_csv_file_to_destination_bucket = GoogleCloudStorageToGoogleCloudStorageOperator(
