...
with DAG(
    ...
    storms_database_by_year = kubernetes_engine.GKEStartPodOperator(
        ...
        env_vars={
            ...
            "SOURCE_URL": '{\n    "root": "ftp://ftp.ncdc.noaa.gov/pub/data/swdi/stormevents/csvfiles",\n    "storms_details": "StormEvents_details-ftp_v1.0_d*.csv.gz",\n    "storms_locations": "StormEvents_locations-ftp_v1.0_d*.csv.gz"\n}',
            ...
            "TABLE_ID": "storms_yyyy",
            "TARGET_GCS_BUCKET": "{{ var.value.composer_bucket }}",
            "TARGET_GCS_PATH": "data/noaa/storms_db/data_output.csv",
            "SCHEMA_PATH": "data/noaa/schema/noaa_severe_storms_schema.json",
            "DROP_DEST_TABLE": "N",
            "INPUT_FIELD_DELIMITER": ",",
            "FULL_DATA_LOAD": "N",
            "REMOVE_SOURCE_FILE": "Y",
