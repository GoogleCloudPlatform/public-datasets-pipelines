...
with DAG(
    ...
    transform_csv = kubernetes_pod_operator.KubernetesPodOperator(
        ...
        image="{{ var.json.noaa.container_registry.run_csv_transform_kub_hurricanes }}",
        env_vars={
            ...
            "TARGET_GCS_PATH": "data/noaa/hurricanes/data_output.csv",
        },
    ...
    load_to_bq = gcs_to_bq.GoogleCloudStorageToBigQueryOperator(
        ...
        source_objects=["data/noaa/hurricanes/data_output.csv"],
        source_format="CSV",
        destination_project_dataset_table="noaa.hurricanes",
        skip_leading_rows=1,
        ...
        schema_fields=[
            ...
            {"name": "season", "type": "STRING", "description": "", "mode": "NULLABLE"},
            {
                "name": "number",
                "type": "INTEGER",
            ...
            {"name": "bom_ci", "type": "FLOAT", "description": "", "mode": "NULLABLE"},
            {
                "name": "bom_rmw",
                "type": "INTEGER",
