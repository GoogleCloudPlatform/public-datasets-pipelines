...
with DAG(
    dag_id="new_york_taxi_trips.tlc_yellow_trips_2018",
    ...
    tlc_yellow_trips_2018_transform_csv = kubernetes_pod_operator.KubernetesPodOperator(
        task_id="tlc_yellow_trips_2018_transform_csv",
        startup_timeout_seconds=600,
        name="tlc_yellow_trips_2018",
        namespace="default",
        affinity={
            "nodeAffinity": {
    ...
    load_tlc_yellow_trips_2018_to_bq = gcs_to_bq.GoogleCloudStorageToBigQueryOperator(
        task_id="load_tlc_yellow_trips_2018_to_bq",
        bucket="{{ var.value.composer_bucket }}",
        source_objects=[
            "data/new_york_taxi_trips/tlc_yellow_trips_2018/data_output.csv"
        ],
        source_format="CSV",
        destination_project_dataset_table="new_york_taxi_trips.tlc_yellow_trips_2018",
        skip_leading_rows=1,
    ...
    tlc_yellow_trips_2018_transform_csv >> load_tlc_yellow_trips_2018_to_bq
