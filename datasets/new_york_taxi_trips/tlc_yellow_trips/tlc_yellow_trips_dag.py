...
with DAG(
    ...
    transform_csv = kubernetes_pod_operator.KubernetesPodOperator(
        ...
        env_vars={
            "SOURCE_URL": "https://s3.amazonaws.com/nyc-tlc/trip+data/yellow_tripdata_",
            "SOURCE_YEARS_TO_LOAD": "{{ var.json.new_york_taxi_trips.container_registry.yellow_trips_years_to_load }}",
            "SOURCE_FILE": "files/data.csv",
            "TARGET_FILE": "files/data_output.csv",
            "CHUNKSIZE": "1500000",
            "TARGET_GCS_BUCKET": "{{ var.value.composer_bucket }}",
            "TARGET_GCS_PATH": "data/new_york_taxi_trips/tlc_yellow_trips/data_output.csv",
            "PIPELINE_NAME": "tlc_yellow_trips",
            "CSV_HEADERS": '["vendor_id", "pickup_datetime", "dropoff_datetime", "passenger_count", "trip_distance", "rate_code",\n "store_and_fwd_flag", "payment_type", "fare_amount", "extra", "mta_tax", "tip_amount", "tolls_amount", "imp_surcharge",\n "total_amount", "pickup_location_id", "dropoff_location_id" ]',
    ...
    load_to_bq_year_0 = gcs_to_bq.GoogleCloudStorageToBigQueryOperator(
        ...
        schema_object="schema/new_york_taxi_trips/tlc_yellow_trips/yellow_trips_schema.json",
        source_format="CSV",
        skip_leading_rows=1,
