...
with DAG(
    dag_id="us_climate_normals.annualseasonal_load",
    ...
    annualseasonal_load = kubernetes_engine.GKEStartPodOperator(
        ...
        env_vars={
            ...
            "SCHEMA_FILEPATH": "{{ var.json.us_climate_normals.container_registry.dest_folder }}",
