...
with DAG(
    ...
    irs_990_2016_transform_csv = kubernetes_pod_operator.KubernetesPodOperator(
    ...
    load_irs_990_2016_to_bq = gcs_to_bq.GoogleCloudStorageToBigQueryOperator(
    ...
    irs_990_2016_transform_csv >> load_irs_990_2016_to_bq
