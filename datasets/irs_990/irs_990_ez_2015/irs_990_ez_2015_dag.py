...
with DAG(
    dag_id="irs_990.irs_990_ez_2015",
    ...
    irs_990_ez_2015_transform_csv = kubernetes_pod_operator.KubernetesPodOperator(
        ...
        env_vars={
            "SOURCE_URL": "https://www.irs.gov/pub/irs-soi/15eofinextractEZ.dat",
            "SOURCE_FILE": "files/data.dat",
            "TARGET_FILE": "files/data_output.csv",
            "TARGET_GCS_BUCKET": "{{ var.json.shared.composer_bucket }}",
            "TARGET_GCS_PATH": "data/irs_990/irs_990_ez_2015/data_output.csv",
            "PIPELINE_NAME": "irs_990_ez_2015",
    ...
    load_irs_990_ez_2015_to_bq = gcs_to_bq.GoogleCloudStorageToBigQueryOperator(
        task_id="load_irs_990_ez_2015_to_bq",
        bucket="{{ var.json.shared.composer_bucket }}",
        source_objects=["data/irs_990/irs_990_ez_2015/data_output.csv"],
        source_format="CSV",
        destination_project_dataset_table="irs_990.irs_990_ez_2015",
        skip_leading_rows=1,
    ...
    irs_990_ez_2015_transform_csv >> load_irs_990_ez_2015_to_bq
