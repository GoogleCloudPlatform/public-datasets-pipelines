...
with DAG(
    dag_id="irs_990.irs_990_pf_2016",
    ...
    irs_990_pf_2016_transform_csv = kubernetes_pod.KubernetesPodOperator(
        ...
        env_vars={
            "SOURCE_URL": "https://www.irs.gov/pub/irs-soi/16eofinextract990pf.zip",
    ...
    irs_990_pf_2016_transform_csv >> load_irs_990_pf_2016_to_bq
