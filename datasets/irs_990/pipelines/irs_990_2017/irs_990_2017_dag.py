...
with DAG(
    ...
    irs_990_2017_transform_csv = kubernetes_engine.GKEStartPodOperator(
    ...
    load_irs_990_2017_to_bq = gcs_to_bigquery.GCSToBigQueryOperator(
