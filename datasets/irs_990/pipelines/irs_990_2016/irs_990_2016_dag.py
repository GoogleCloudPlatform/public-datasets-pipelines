...
with DAG(
    ...
    irs_990_2016_transform_csv = kubernetes_engine.GKEStartPodOperator(
        task_id="irs_990_2016_transform_csv",
        startup_timeout_seconds=600,
        name="irs_990_2016",
        namespace="default",
        project_id="{{ var.value.gcp_project }}",
        location="us-central1-c",
        cluster_name="pdp-irs-990-2016",
        ...
        env_vars={
            ...
            "TARGET_GCS_PATH": "data/irs_990/irs_990_2016/data_output.csv",
            "PIPELINE_NAME": "irs_990_2016",
    ...
    load_irs_990_2016_to_bq = gcs_to_bigquery.GCSToBigQueryOperator(
        task_id="load_irs_990_2016_to_bq",
        bucket="{{ var.value.composer_bucket }}",
        source_objects=["data/irs_990/irs_990_2016/data_output.csv"],
        source_format="CSV",
        destination_project_dataset_table="irs_990.irs_990_2016",
        skip_leading_rows=1,
