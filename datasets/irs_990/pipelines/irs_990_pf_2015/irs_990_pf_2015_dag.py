...
with DAG(
    ...
    irs_990_pf_2015_transform_csv = kubernetes_pod.KubernetesPodOperator(
        ...
        env_vars={
            "SOURCE_URL": "https://www.irs.gov/pub/irs-soi/15eofinextract990pf.zip",
    ...
    load_irs_990_pf_2015_to_bq = gcs_to_bigquery.GCSToBigQueryOperator(
