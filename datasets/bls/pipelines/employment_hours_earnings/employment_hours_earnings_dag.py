...
with DAG(
    ...
    transform_csv = kubernetes_pod.KubernetesPodOperator(
        ...
        env_vars={
            "SOURCE_URLS": '["gs://pdp-feeds-staging/Bureau/employment_list_join.csv","gs://pdp-feeds-staging/Bureau_new/ce.csv"]',
            "SOURCE_FILES": '["files/data1.csv","files/data2.csv"]',
            "CHUNKSIZE": "50000",
            "TARGET_FILE": "files/data_output.csv",
            "TARGET_GCS_BUCKET": "{{ var.value.composer_bucket }}",
            "TARGET_GCS_PATH": "data/bls/employment_hours_earnings/data_output.csv",
            "PIPELINE_NAME": "employment_hours_earnings",
    ...
    load_to_bq = gcs_to_bigquery.GCSToBigQueryOperator(
        ...
        source_objects=["data/bls/employment_hours_earnings/data_output_*.csv"],
        source_format="CSV",
        destination_project_dataset_table="bls.employment_hours_earnings",
        skip_leading_rows=1,
