...
with DAG(
    ...
    transform_csv = kubernetes_pod.KubernetesPodOperator(
        ...
        env_vars={
            "SOURCE_URLS": '["gs://pdp-feeds-staging/Bureau/unemployment_list_join.csv","gs://pdp-feeds-staging/Bureau_new/ln.csv"]',
    ...
    load_to_bq = gcs_to_bigquery.GCSToBigQueryOperator(
        ...
        source_objects=["data/bls/unemployment_cps/data_output_*.csv"],
        source_format="CSV",
        destination_project_dataset_table="bls.unemployment_cps",
        skip_leading_rows=1,
