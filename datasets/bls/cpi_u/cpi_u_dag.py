...
with DAG(
    ...
    transform_csv = kubernetes_pod_operator.KubernetesPodOperator(
        ...
        env_vars={
            "SOURCE_URL": '["gs://pdp-feeds-staging/Bureau/inflat-prices_listarea_area_join.csv","gs://pdp-feeds-staging/Bureau/cu.item.tsv"]',
            ...
            "FILTER_HEADERS": '["series_id","year","period","value","footnote_codes","survey_abbreviation","seasonal_code","periodicity_code","area_code","area_name","item_code","item_name","date"]',
