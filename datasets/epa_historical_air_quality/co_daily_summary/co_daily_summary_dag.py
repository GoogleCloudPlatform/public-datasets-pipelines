...
with DAG(
    dag_id="epa_historical_air_quality.co_daily_summary",
    ...
    transform_csv = kubernetes_pod.KubernetesPodOperator(
        ...
        env_vars={
            ...
            "TARGET_GCS_PATH": "data/epa_historical_air_quality/co_daily_summary/files/data_output.csv",
    ...
    load_to_bq = gcs_to_bigquery.GCSToBigQueryOperator(
        ...
        source_objects=[
            "data/epa_historical_air_quality/co_daily_summary/files/data_output.csv"
        ],
        source_format="CSV",
