...
with DAG(
    dag_id="epa_historical_air_quality.pm25_nonfrm_daily_summary",
    ...
    transform_csv = kubernetes_pod.KubernetesPodOperator(
        ...
        name="pm25_nonfrm_daily_summary",
        namespace="default",
        affinity={
            "nodeAffinity": {
        ...
        env_vars={
            "SOURCE_URL": "https://aqs.epa.gov/aqsweb/airdata/daily_88502_~year~.zip",
            "START_YEAR": "1990",
            "SOURCE_FILE": "files/data.csv",
            "TARGET_FILE": "files/data_output.csv",
            "CHUNKSIZE": "2500000",
            "TARGET_GCS_BUCKET": "{{ var.value.composer_bucket }}",
            "TARGET_GCS_PATH": "data/epa_historical_air_quality/pm25_nonfrm_daily_summary/files/data_output.csv",
    ...
    load_to_bq = gcs_to_bigquery.GCSToBigQueryOperator(
        ...
        source_objects=[
            "data/epa_historical_air_quality/pm25_nonfrm_daily_summary/files/data_output.csv"
        ],
        source_format="CSV",
        destination_project_dataset_table="{{ var.json.epa_historical_air_quality.container_registry.pm25_nonfrm_daily_summary_destination_table }}",
        skip_leading_rows=1,
