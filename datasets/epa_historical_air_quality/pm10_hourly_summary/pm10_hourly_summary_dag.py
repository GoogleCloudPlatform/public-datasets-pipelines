...
with DAG(
    ...
    load_to_bq = gcs_to_bigquery.GCSToBigQueryOperator(
        ...
        source_objects=[
            "data/epa_historical_air_quality/pm10_hourly_summary/data_output.csv"
        ],
        source_format="CSV",
        destination_project_dataset_table="{{ var.value.container_registry.pm10_hourly_summary_destination_table }}",
        skip_leading_rows=1,
