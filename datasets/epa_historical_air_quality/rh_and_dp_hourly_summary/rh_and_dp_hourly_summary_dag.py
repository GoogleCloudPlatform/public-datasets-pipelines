...
with DAG(
    dag_id="epa_historical_air_quality.rh_and_dp_hourly_summary",
    ...
    transform_csv = kubernetes_pod.KubernetesPodOperator(
        ...
        env_vars={
            "SOURCE_URL": "https://aqs.epa.gov/aqsweb/airdata/hourly_RH_DP_~year~.zip",
            "START_YEAR": "1990",
            "SOURCE_FILE": "files/data.csv",
            "TARGET_FILE": "files/data_output.csv",
            "CHUNKSIZE": "2500000",
            "TARGET_GCS_BUCKET": "{{ var.value.composer_bucket }}",
            "TARGET_GCS_PATH": "data/epa_historical_air_quality/rh_and_dp_hourly_summary/files/data_output.csv",
    ...
    load_to_bq = gcs_to_bigquery.GCSToBigQueryOperator(
        ...
        source_objects=[
            "data/epa_historical_air_quality/rh_and_dp_hourly_summary/files/data_output.csv"
        ],
        source_format="CSV",
        destination_project_dataset_table="{{ var.json.epa_historical_air_quality.container_registry.rh_and_dp_hourly_summary_destination_table }}",
        skip_leading_rows=1,
