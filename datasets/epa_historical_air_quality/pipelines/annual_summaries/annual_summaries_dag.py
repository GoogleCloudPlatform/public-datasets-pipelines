...
with DAG(
    ...
    transform_and_load_csv = kubernetes_engine.GKEStartPodOperator(
        ...
        project_id="{{ var.value.gcp_project }}",
        location="us-central1-c",
        cluster_name="epa-air-qual--annual-summaries",
        ...
        env_vars={
            ...
            "TABLE_ID": "{{ var.json.epa_historical_air_quality.container_registry.table_id.annual_summaries }}",
            "CHUNKSIZE": "1500000",
            "SCHEMA_PATH": "{{ var.json.new_york_taxi_trips.container_registry.schema_path.annual_summaries }}",
