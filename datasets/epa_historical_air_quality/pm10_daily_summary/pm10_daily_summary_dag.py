...
with DAG(
    ...
    transform_csv = kubernetes_pod.KubernetesPodOperator(
        ...
        resources={'request_memory': '8G', 'request_cpu': '3', 'request_ephemeral_storage': '5G'},
    )
    ...
    load_to_bq = gcs_to_bigquery.GCSToBigQueryOperator(
        ...
        source_objects=['data/epa_historical_air_quality/pm10_daily_summary/files/data_output.csv'],
        source_format="CSV",
        destination_project_dataset_table="{{ var.json.epa_historical_air_quality.destination_tables.pm10_daily_summary }}",
        skip_leading_rows=1,
    ...
    or the day (the previous field) was taken.",
                "mode": "NULLABLE",
            },
            {
                "name": "aqi",
