...
with DAG(
    ...
    transform_csv = kubernetes_pod.KubernetesPodOperator(
        ...
        env_vars={
            ...
            "TARGET_GCS_PATH": "data/epa_historical_air_quality/hap_hourly_summary/files/data_output.csv",
    ...
    load_to_bq = gcs_to_bigquery.GCSToBigQueryOperator(
        ...
        source_objects=[
            "data/epa_historical_air_quality/hap_hourly_summary/files/data_output.csv"
        ],
        source_format="CSV",
        destination_project_dataset_table="{{ var.json.epa_historical_air_quality.container_registry.hap_hourly_summary_destination_table }}",
        skip_leading_rows=1,
