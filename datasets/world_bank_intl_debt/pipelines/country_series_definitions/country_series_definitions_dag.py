...
with DAG(
    dag_id="world_bank_intl_debt.country_series_definitions",
    ...
    country_series_definitions_transform_csv = kubernetes_pod_operator.KubernetesPodOperator(
        ...
        env_vars={
            "SOURCE_URL": "gs://pdp-feeds-staging/RelayWorldBank/IDS_CSV/IDSCountry-Series.csv",
    ...
    load_country_series_definitions_to_bq = gcs_to_bq.GoogleCloudStorageToBigQueryOperator(
        ...
        source_objects=[
            "data/world_bank_intl_debt/country_series_definitions/data_output.csv"
        ],
        source_format="CSV",
