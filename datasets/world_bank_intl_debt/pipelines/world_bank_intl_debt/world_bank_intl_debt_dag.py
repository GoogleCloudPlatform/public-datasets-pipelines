...
with DAG(
    ...
    copy_gcs_to_gcs2 = bash.BashOperator(
        ...
        bash_command="gsutil cp gs://pdp-feeds-staging/RelayWorldBank/IDS_CSV/IDSCountry.csv gs://{{ var.value.composer_bucket }}/data/world_bank_intl_debt/raw_files/ ;",
    )
    ...
    copy_gcs_to_gcs3 = bash.BashOperator(
        ...
        bash_command="gsutil cp gs://pdp-feeds-staging/RelayWorldBank/IDS_CSV/IDSSeries.csv gs://{{ var.value.composer_bucket }}/data/world_bank_intl_debt/raw_files/ ;",
    )
    ...
    copy_gcs_to_gcs4 = bash.BashOperator(
        ...
        bash_command="gsutil cp gs://pdp-feeds-staging/RelayWorldBank/IDS_CSV/IDSSeries-Time.csv gs://{{ var.value.composer_bucket }}/data/world_bank_intl_debt/raw_files/ ;",
    )
