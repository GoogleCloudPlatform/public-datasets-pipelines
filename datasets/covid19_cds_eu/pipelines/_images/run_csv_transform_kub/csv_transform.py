...
def main(
    ...
    logging.info(
        f"COVID-19 CDS EU {pipeline_name} process started at "
    ...
    logging.info("Transform: Create new column location_geom... ")
    df["location_geom"] = (
        "POINT("
    ...
    logging.info(
        f"COVID-19 CDS EU {pipeline_name} process completed at "
        + str(datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S"))
    )
