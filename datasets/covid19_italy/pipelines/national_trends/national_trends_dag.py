...
with DAG(
    ...
    copy_data_file_EU = bash.BashOperator(
        ...
        bash_command="gsutil cp gs://{{ var.value.composer_bucket }}/data/covid19_italy/national_trends/data_output.csv gs://public-datasets-dev-covid19-italy-eu/national/",
    )
