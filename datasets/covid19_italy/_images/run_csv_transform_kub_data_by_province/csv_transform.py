...
# CSV transform for: covid19_italy.data_by_province
...
def main(
    ...
    logging.info(
        f"Covid-19 Italy (By Province) process started at "
    ...
    # log completion
    logging.info(
        f"Covid-19 Italy (By Province) process completed at "
        + str(datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S"))
    )
