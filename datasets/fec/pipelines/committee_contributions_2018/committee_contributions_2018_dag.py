...
with DAG(
    dag_id="fec.committee_contributions_2018",
    ...
    committee_contributions_2018_transform_csv = kubernetes_pod.KubernetesPodOperator(
    ...
    load_committee_contributions_2018_to_bq = gcs_to_bigquery.GCSToBigQueryOperator(
    ...
    (
        committee_contributions_2018_transform_csv
        >> load_committee_contributions_2018_to_bq
    )
