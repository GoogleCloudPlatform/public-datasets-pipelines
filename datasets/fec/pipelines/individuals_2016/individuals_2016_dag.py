...
with DAG(
    ...
    download_zip_file = bash.BashOperator(
        ...
        bash_command='mkdir -p $data_dir/individuals\ncurl -o $data_dir/individuals/indiv16.zip -L $fec\nunzip -p $data_dir/individuals/indiv16.zip  $data_dir/individuals/itcont.txt \u003e itcont.txt\nsplit -l 3000000 --additional-suffix=.txt "$data_dir/individuals/itcont.txt" "$data_dir/individuals/F_"\n',
        env={
    ...
    individuals_2016_transform_csv_1 = kubernetes_pod.KubernetesPodOperator(
        ...
        env_vars={
            ...
            "SOURCE_GCS_OBJECT": "data/fec/individuals/F_aa.txt",
    ...
    individuals_2016_transform_csv_2 = kubernetes_pod.KubernetesPodOperator(
        ...
        env_vars={
            "SOURCE_GCS_BUCKET": "{{ var.value.composer_bucket }}",
            "SOURCE_GCS_OBJECT": "data/fec/individuals/F_ab.txt",
    ...
    individuals_2016_transform_csv_3 = kubernetes_pod.KubernetesPodOperator(
        ...
        env_vars={
            "SOURCE_GCS_BUCKET": "{{ var.value.composer_bucket }}",
            "SOURCE_GCS_OBJECT": "data/fec/individuals/F_ac.txt",
    ...
    # Run CSV transform within kubernetes pod
    individuals_2016_transform_csv_4 = kubernetes_pod.KubernetesPodOperator(
        task_id="individuals_2016_transform_csv_4",
        startup_timeout_seconds=600,
        name="individuals_2016",
        namespace="composer",
        service_account_name="datasets",
        ...
        env_vars={
            "SOURCE_GCS_BUCKET": "{{ var.value.composer_bucket }}",
            "SOURCE_GCS_OBJECT": "data/fec/individuals/F_ad.txt",
            "SOURCE_FILE": "files/F4.txt",
            "TARGET_FILE": "files/data_output.csv",
            "TARGET_GCS_BUCKET": "{{ var.value.composer_bucket }}",
            "TARGET_GCS_PATH": "data/fec/individuals/data_output_4.csv",
            "PIPELINE_NAME": "individuals_2016",
            "CSV_HEADERS": '["cmte_id","amndt_ind","rpt_tp","transaction_pgi","image_num","transaction_tp","entity_tp","name","city","state", "zip_code","employer","occupation","transaction_dt","transaction_amt","other_id","tran_id","file_num", "memo_cd","memo_text","sub_id"]',
            "RENAME_MAPPINGS": '{"0":"cmte_id","1":"amndt_ind","2":"rpt_tp","3":"transaction_pgi","4":"image_num","5":"transaction_tp", "6":"entity_tp","7":"name","8":"city","9":"state","10":"zip_code","11":"employer", "12":"occupation","13":"transaction_dt","14":"transaction_amt","15":"other_id","16":"tran_id", "17":"file_num","18":"memo_cd","19":"memo_text","20":"sub_id"}',
        },
    ...
    # Task to load CSV data to a BigQuery table
    load_individuals_2016_4_to_bq = gcs_to_bigquery.GCSToBigQueryOperator(
        task_id="load_individuals_2016_4_to_bq",
        bucket="{{ var.value.composer_bucket }}",
        source_objects=["data/fec/individuals/data_output_4.csv"],
        source_format="CSV",
        destination_project_dataset_table="fec.individuals_2016",
        skip_leading_rows=1,
        allow_quoted_newlines=True,
    ...
    # Run CSV transform within kubernetes pod
    individuals_2016_transform_csv_5 = kubernetes_pod.KubernetesPodOperator(
        task_id="individuals_2016_transform_csv_5",
        startup_timeout_seconds=600,
        name="individuals_2016",
        namespace="composer",
        service_account_name="datasets",
        ...
        env_vars={
            "SOURCE_GCS_BUCKET": "{{ var.value.composer_bucket }}",
            "SOURCE_GCS_OBJECT": "data/fec/individuals/F_ae.txt",
            "SOURCE_FILE": "files/F5.txt",
            "TARGET_FILE": "files/data_output.csv",
            "TARGET_GCS_BUCKET": "{{ var.value.composer_bucket }}",
            "TARGET_GCS_PATH": "data/fec/individuals/data_output_5.csv",
            "PIPELINE_NAME": "individuals_2016",
            "CSV_HEADERS": '["cmte_id","amndt_ind","rpt_tp","transaction_pgi","image_num","transaction_tp","entity_tp","name","city","state", "zip_code","employer","occupation","transaction_dt","transaction_amt","other_id","tran_id","file_num", "memo_cd","memo_text","sub_id"]',
            "RENAME_MAPPINGS": '{"0":"cmte_id","1":"amndt_ind","2":"rpt_tp","3":"transaction_pgi","4":"image_num","5":"transaction_tp", "6":"entity_tp","7":"name","8":"city","9":"state","10":"zip_code","11":"employer", "12":"occupation","13":"transaction_dt","14":"transaction_amt","15":"other_id","16":"tran_id", "17":"file_num","18":"memo_cd","19":"memo_text","20":"sub_id"}',
        },
    ...
    # Task to load CSV data to a BigQuery table
    load_individuals_2016_5_to_bq = gcs_to_bigquery.GCSToBigQueryOperator(
        task_id="load_individuals_2016_5_to_bq",
        bucket="{{ var.value.composer_bucket }}",
        source_objects=["data/fec/individuals/data_output_5.csv"],
        source_format="CSV",
        destination_project_dataset_table="fec.individuals_2016",
        skip_leading_rows=1,
        allow_quoted_newlines=True,
    ...
    # Run CSV transform within kubernetes pod
    individuals_2016_transform_csv_6 = kubernetes_pod.KubernetesPodOperator(
        task_id="individuals_2016_transform_csv_6",
        startup_timeout_seconds=600,
        name="individuals_2016",
        namespace="composer",
        service_account_name="datasets",
        ...
        env_vars={
            "SOURCE_GCS_BUCKET": "{{ var.value.composer_bucket }}",
            "SOURCE_GCS_OBJECT": "data/fec/individuals/F_af.txt",
            "SOURCE_FILE": "files/F6.txt",
            "TARGET_FILE": "files/data_output.csv",
            "TARGET_GCS_BUCKET": "{{ var.value.composer_bucket }}",
            "TARGET_GCS_PATH": "data/fec/individuals/data_output_6.csv",
            "PIPELINE_NAME": "individuals_2016",
            "CSV_HEADERS": '["cmte_id","amndt_ind","rpt_tp","transaction_pgi","image_num","transaction_tp","entity_tp","name","city","state", "zip_code","employer","occupation","transaction_dt","transaction_amt","other_id","tran_id","file_num", "memo_cd","memo_text","sub_id"]',
            "RENAME_MAPPINGS": '{"0":"cmte_id","1":"amndt_ind","2":"rpt_tp","3":"transaction_pgi","4":"image_num","5":"transaction_tp", "6":"entity_tp","7":"name","8":"city","9":"state","10":"zip_code","11":"employer", "12":"occupation","13":"transaction_dt","14":"transaction_amt","15":"other_id","16":"tran_id", "17":"file_num","18":"memo_cd","19":"memo_text","20":"sub_id"}',
        },
    ...
    # Task to load CSV data to a BigQuery table
    load_individuals_2016_6_to_bq = gcs_to_bigquery.GCSToBigQueryOperator(
        task_id="load_individuals_2016_6_to_bq",
        bucket="{{ var.value.composer_bucket }}",
        source_objects=["data/fec/individuals/data_output_6.csv"],
        source_format="CSV",
        destination_project_dataset_table="fec.individuals_2016",
        skip_leading_rows=1,
        allow_quoted_newlines=True,
    ...
    # Run CSV transform within kubernetes pod
    individuals_2016_transform_csv_7 = kubernetes_pod.KubernetesPodOperator(
        task_id="individuals_2016_transform_csv_7",
        startup_timeout_seconds=600,
        name="individuals_2016",
        namespace="composer",
        service_account_name="datasets",
        ...
        env_vars={
            "SOURCE_GCS_BUCKET": "{{ var.value.composer_bucket }}",
            "SOURCE_GCS_OBJECT": "data/fec/individuals/F_ag.txt",
            "SOURCE_FILE": "files/F7.txt",
            "TARGET_FILE": "files/data_output.csv",
            "TARGET_GCS_BUCKET": "{{ var.value.composer_bucket }}",
            "TARGET_GCS_PATH": "data/fec/individuals/data_output_7.csv",
            "PIPELINE_NAME": "individuals_2016",
            "CSV_HEADERS": '["cmte_id","amndt_ind","rpt_tp","transaction_pgi","image_num","transaction_tp","entity_tp","name","city","state", "zip_code","employer","occupation","transaction_dt","transaction_amt","other_id","tran_id","file_num", "memo_cd","memo_text","sub_id"]',
            "RENAME_MAPPINGS": '{"0":"cmte_id","1":"amndt_ind","2":"rpt_tp","3":"transaction_pgi","4":"image_num","5":"transaction_tp", "6":"entity_tp","7":"name","8":"city","9":"state","10":"zip_code","11":"employer", "12":"occupation","13":"transaction_dt","14":"transaction_amt","15":"other_id","16":"tran_id", "17":"file_num","18":"memo_cd","19":"memo_text","20":"sub_id"}',
        },
    ...
    # Task to load CSV data to a BigQuery table
    load_individuals_2016_7_to_bq = gcs_to_bigquery.GCSToBigQueryOperator(
        task_id="load_individuals_2016_7_to_bq",
        bucket="{{ var.value.composer_bucket }}",
        source_objects=["data/fec/individuals/data_output_7.csv"],
        source_format="CSV",
        destination_project_dataset_table="fec.individuals_2016",
        skip_leading_rows=1,
        allow_quoted_newlines=True,
    ...
    (
        ...
        >> individuals_2016_transform_csv_4
        >> load_individuals_2016_4_to_bq
        >> individuals_2016_transform_csv_5
        >> load_individuals_2016_5_to_bq
        >> individuals_2016_transform_csv_6
        >> load_individuals_2016_6_to_bq
        >> individuals_2016_transform_csv_7
        >> load_individuals_2016_7_to_bq
    )
