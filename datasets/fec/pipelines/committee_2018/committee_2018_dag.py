...
with DAG(
    ...
    committee_2018_transform_csv = kubernetes_pod.KubernetesPodOperator(
    ...
    load_committee_2018_to_bq = gcs_to_bigquery.GCSToBigQueryOperator(
