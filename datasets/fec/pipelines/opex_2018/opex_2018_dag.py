...
with DAG(
    ...
    opex_2018_transform_csv = kubernetes_pod.KubernetesPodOperator(
        task_id="opex_2018_transform_csv",
        ...
        env_vars={
            "SOURCE_URL": "https://cg-519a459a-0ea3-42c2-b7bc-fa1143481f74.s3-us-gov-west-1.amazonaws.com/bulk-downloads/2018/oppexp18.zip",
            "SOURCE_FILE_ZIP_FILE": "files/zip_file.zip",
            "SOURCE_FILE_PATH": "files/",
            "SOURCE_FILE": "files/oppexp.txt",
            "TARGET_FILE": "files/data_output.csv",
            "TARGET_GCS_BUCKET": "{{ var.value.composer_bucket }}",
            "TARGET_GCS_PATH": "data/fec/opex_2018/data_output.csv",
            "PIPELINE_NAME": "opex_2018",
    ...
    load_opex_2018_to_bq = gcs_to_bigquery.GCSToBigQueryOperator(
        task_id="load_opex_2018_to_bq",
        bucket="{{ var.value.composer_bucket }}",
        source_objects=["data/fec/opex_2018/data_output.csv"],
        source_format="CSV",
        destination_project_dataset_table="fec.opex_2018",
        skip_leading_rows=1,
    ...
    opex_2018_transform_csv >> load_opex_2018_to_bq
