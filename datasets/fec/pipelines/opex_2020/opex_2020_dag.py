...
with DAG(
    ...
    opex_2020_transform_csv = kubernetes_pod.KubernetesPodOperator(
    ...
    load_opex_2020_to_bq = gcs_to_bigquery.GCSToBigQueryOperator(
        task_id="load_opex_2020_to_bq",
        bucket="{{ var.value.composer_bucket }}",
        source_objects=["data/fec/opex_2020/data_output.csv"],
        source_format="CSV",
        destination_project_dataset_table="fec.opex_2020",
        skip_leading_rows=1,
    ...
    opex_2020_transform_csv >> load_opex_2020_to_bq
