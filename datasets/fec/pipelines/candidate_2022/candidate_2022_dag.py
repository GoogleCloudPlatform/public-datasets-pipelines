...
with DAG(
    ...
    candidate_2022_transform_csv = kubernetes_pod.KubernetesPodOperator(
        task_id="candidate_2022_transform_csv",
        ...
        env_vars={
            "SOURCE_URL": "https://cg-519a459a-0ea3-42c2-b7bc-fa1143481f74.s3-us-gov-west-1.amazonaws.com/bulk-downloads/2022/cn22.zip",
            "SOURCE_FILE_ZIP_FILE": "files/zip_file.zip",
            "SOURCE_FILE_PATH": "files/",
            "SOURCE_FILE": "files/cn.txt",
            "TARGET_FILE": "files/data_output.csv",
            "TARGET_GCS_BUCKET": "{{ var.value.composer_bucket }}",
            "TARGET_GCS_PATH": "data/fec/candidate_2022/data_output.csv",
            "PIPELINE_NAME": "candidate_2022",
    ...
    load_candidate_2022_to_bq = gcs_to_bigquery.GCSToBigQueryOperator(
        task_id="load_candidate_2022_to_bq",
        bucket="{{ var.value.composer_bucket }}",
        source_objects=["data/fec/candidate_2022/data_output.csv"],
        source_format="CSV",
        destination_project_dataset_table="fec.candidate_2022",
        skip_leading_rows=1,
    ...
    candidate_2022_transform_csv >> load_candidate_2022_to_bq
