...
with DAG(
    ...
    candidate_2016_transform_csv = kubernetes_pod.KubernetesPodOperator(
        task_id="candidate_2016_transform_csv",
        ...
        env_vars={
            "SOURCE_URL": "https://cg-519a459a-0ea3-42c2-b7bc-fa1143481f74.s3-us-gov-west-1.amazonaws.com/bulk-downloads/2016/cn16.zip",
            "SOURCE_FILE_ZIP_FILE": "files/zip_file.zip",
            "SOURCE_FILE_PATH": "files/",
            "SOURCE_FILE": "files/cn.txt",
            "TARGET_FILE": "files/data_output.csv",
            "TARGET_GCS_BUCKET": "{{ var.value.composer_bucket }}",
            "TARGET_GCS_PATH": "data/fec/candidate_2016/data_output.csv",
            "PIPELINE_NAME": "candidate_2016",
            ...
            "RENAME_MAPPINGS": '{0:"cand_id",1:"cand_name",2:"cand_pty_affiliation",3:"cand_election_yr",4:"cand_office_st",5:"cand_office", 6:"cand_office_district",7:"cand_ici",8:"cand_status",9:"cand_pcc",10:"cand_st1",11:"cand_st2", 12:"cand_city",13:"cand_st",14:"cand_zip"}',
        },
        resources={
            "request_memory": "3G",
            "request_cpu": "1",
    ...
    load_candidate_2016_to_bq = gcs_to_bigquery.GCSToBigQueryOperator(
        task_id="load_candidate_2016_to_bq",
        bucket="{{ var.value.composer_bucket }}",
        source_objects=["data/fec/candidate_2016/data_output.csv"],
        source_format="CSV",
        destination_project_dataset_table="fec.candidate_2016",
        skip_leading_rows=1,
    ...
    candidate_2016_transform_csv >> load_candidate_2016_to_bq
