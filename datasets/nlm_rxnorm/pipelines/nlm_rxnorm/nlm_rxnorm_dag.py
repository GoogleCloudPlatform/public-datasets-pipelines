...
with DAG(
    ...
    process_rxnatomarchive = kubernetes_engine.GKEStartPodOperator(
        ...
        env_vars={
            ...
            "SCHEMA_FILEPATH": "data/nlm_rxnorm/schema/rxnatomarchive_schema.json",
            "PROJECT_ID": "{{ var.value.gcp_project }}",
    ...
    process_rxnconso = kubernetes_engine.GKEStartPodOperator(
        ...
        env_vars={
            ...
            "TARGET_GCS_BUCKET": "{{ var.value.composer_bucket }}",
            "TARGET_GCS_PATH": "data/nlm_rxnorm",
            "SCHEMA_FILEPATH": "data/nlm_rxnorm/schema/rxnconso_schema.json",
            "PROJECT_ID": "{{ var.value.gcp_project }}",
            "DATASET_ID": "nlm_rxnorm",
        },
        resources={"limit_memory": "8G", "limit_cpu": "3"},
    ...
    process_rxncui = kubernetes_engine.GKEStartPodOperator(
        ...
        env_vars={
            ...
            "TARGET_GCS_BUCKET": "{{ var.value.composer_bucket }}",
            "TARGET_GCS_PATH": "data/nlm_rxnorm",
            "SCHEMA_FILEPATH": "data/nlm_rxnorm/schema/rxncui_schema.json",
            "PROJECT_ID": "{{ var.value.gcp_project }}",
            "DATASET_ID": "nlm_rxnorm",
        },
        resources={"limit_memory": "8G", "limit_cpu": "3"},
    ...
    process_rxncuichange = kubernetes_engine.GKEStartPodOperator(
        ...
        env_vars={
            ...
            "TARGET_GCS_BUCKET": "{{ var.value.composer_bucket }}",
            "TARGET_GCS_PATH": "data/nlm_rxnorm",
            "SCHEMA_FILEPATH": "data/nlm_rxnorm/schema/rxncuichange_schema.json",
            "PROJECT_ID": "{{ var.value.gcp_project }}",
            "DATASET_ID": "nlm_rxnorm",
        },
        resources={"limit_memory": "8G", "limit_cpu": "3"},
    ...
    process_rxndoc = kubernetes_engine.GKEStartPodOperator(
        ...
        env_vars={
            ...
            "TARGET_GCS_BUCKET": "{{ var.value.composer_bucket }}",
            "TARGET_GCS_PATH": "data/nlm_rxnorm",
            "SCHEMA_FILEPATH": "data/nlm_rxnorm/schema/rxndoc_schema.json",
            "PROJECT_ID": "{{ var.value.gcp_project }}",
            "DATASET_ID": "nlm_rxnorm",
        },
        resources={"limit_memory": "8G", "limit_cpu": "3"},
    ...
    process_rxnrel = kubernetes_engine.GKEStartPodOperator(
        ...
        env_vars={
            ...
            "TARGET_GCS_BUCKET": "{{ var.value.composer_bucket }}",
            "TARGET_GCS_PATH": "data/nlm_rxnorm",
            "SCHEMA_FILEPATH": "data/nlm_rxnorm/schema/rxnrel_schema.json",
            "PROJECT_ID": "{{ var.value.gcp_project }}",
            "DATASET_ID": "nlm_rxnorm",
        },
        resources={"limit_memory": "8G", "limit_cpu": "3"},
    ...
    process_rxnsab = kubernetes_engine.GKEStartPodOperator(
        ...
        env_vars={
            ...
            "TARGET_GCS_BUCKET": "{{ var.value.composer_bucket }}",
            "TARGET_GCS_PATH": "data/nlm_rxnorm",
            "SCHEMA_FILEPATH": "data/nlm_rxnorm/schema/rxnsab_schema.json",
            "PROJECT_ID": "{{ var.value.gcp_project }}",
            "DATASET_ID": "nlm_rxnorm",
        },
        resources={"limit_memory": "8G", "limit_cpu": "3"},
    ...
    process_rxnsty = kubernetes_engine.GKEStartPodOperator(
        ...
        env_vars={
            ...
            "TARGET_GCS_BUCKET": "{{ var.value.composer_bucket }}",
            "TARGET_GCS_PATH": "data/nlm_rxnorm",
            "SCHEMA_FILEPATH": "data/nlm_rxnorm/schema/rxnsty_schema.json",
            "PROJECT_ID": "{{ var.value.gcp_project }}",
            "DATASET_ID": "nlm_rxnorm",
        },
        resources={"limit_memory": "8G", "limit_cpu": "3"},
