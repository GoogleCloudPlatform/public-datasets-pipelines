...
with DAG(
    ...
    transform_csv_ny_311_service_requests = kubernetes_engine.GKEStartPodOperator(
        ...
        env_vars={
            ...
            "CHUNKSIZE": "{{ var.json.new_york.container_registry.ny_311_service_requests.chunksize }}",
            "SOURCE_FILE": "files/data_{{ var.json.new_york.container_registry.ny_311_service_requests.dataset_id }}_{{ var.json.new_york.container_registry.ny_311_service_requests.destination_table }}.csv",
            "TARGET_FILE": "files/data_output_{{ var.json.new_york.container_registry.ny_311_service_requests.dataset_id }}_{{ var.json.new_york.container_registry.ny_311_service_requests.destination_table }}.csv",
            "PROJECT_ID": "{{ var.value.gcp_project }}",
            "DATASET_ID": "{{ var.json.new_york.container_registry.ny_311_service_requests.dataset_id }}",
            "TABLE_ID": "{{ var.json.new_york.container_registry.ny_311_service_requests.destination_table }}",
            "TARGET_GCS_BUCKET": "{{ var.value.composer_bucket }}",
            "TARGET_GCS_PATH": "{{ var.json.new_york.container_registry.ny_311_service_requests.target_path }}",
            "SCHEMA_PATH": "{{ var.json.new_york.container_registry.ny_311_service_requests.schema_path }}",
        ...
        resources={"request_ephemeral_storage": "60G", "limit_cpu": "3"},
    )
    ...
    transform_csv_ny_citibike_stations = kubernetes_engine.GKEStartPodOperator(
        ...
        env_vars={
            ...
            "SOURCE_FILE": "files/data_{{ var.json.new_york.container_registry.citibike_stations.dataset_id }}_{{ var.json.new_york.container_registry.citibike_stations.destination_table }}.csv",
            "TARGET_FILE": "files/data_output_{{ var.json.new_york.container_registry.citibike_stations.dataset_id }}_{{ var.json.new_york.container_registry.citibike_stations.destination_table }}.csv",
            "PROJECT_ID": "{{ var.value.gcp_project }}",
            "DATASET_ID": "{{ var.json.new_york.container_registry.citibike_stations.dataset_id }}",
            "TABLE_ID": "{{ var.json.new_york.container_registry.citibike_stations.destination_table }}",
            "TARGET_GCS_BUCKET": "{{ var.value.composer_bucket }}",
    ...
    transform_csv_nypd_mv_collisions = kubernetes_engine.GKEStartPodOperator(
        ...
        env_vars={
            ...
            "SOURCE_FILE": "files/data_{{ var.json.new_york.container_registry.nypd_mv_collisions.dataset_id }}_{{ var.json.new_york.container_registry.nypd_mv_collisions.destination_table }}.csv",
            "TARGET_FILE": "files/data_output_{{ var.json.new_york.container_registry.nypd_mv_collisions.dataset_id }}_{{ var.json.new_york.container_registry.nypd_mv_collisions.destination_table }}.csv",
            "PROJECT_ID": "{{ var.value.gcp_project }}",
    ...
    transform_csv_ny_tree_census_1995 = kubernetes_engine.GKEStartPodOperator(
        ...
        env_vars={
            ...
            "SOURCE_FILE": "files/data_{{ var.json.new_york.container_registry.tree_census_1995.dataset_id }}_{{ var.json.new_york.container_registry.tree_census_1995.destination_table }}.csv",
            "TARGET_FILE": "files/data_output_{{ var.json.new_york.container_registry.tree_census_1995.dataset_id }}_{{ var.json.new_york.container_registry.tree_census_1995.destination_table }}.csv",
            "PROJECT_ID": "{{ var.value.gcp_project }}",
            "DATASET_ID": "{{ var.json.new_york.container_registry.tree_census_1995.dataset_id }}",
            "TABLE_ID": "{{ var.json.new_york.container_registry.tree_census_1995.destination_table }}",
            "TARGET_GCS_BUCKET": "{{ var.value.composer_bucket }}",
