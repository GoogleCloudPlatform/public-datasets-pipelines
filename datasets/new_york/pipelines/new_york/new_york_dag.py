...
with DAG(
    ...
    transform_csv_ny_311_service_requests = kubernetes_engine.GKEStartPodOperator(
        ...
        env_vars={
            ...
            "SOURCE_FILE": "files/data_{{ var.json.new_york.container_registry.311_service_requests.dataset_id }}_{{ var.json.new_york.container_registry.311_service_requests.destination_table }}.csv",
            "TARGET_FILE": "files/data_output_{{ var.json.new_york.container_registry.311_service_requests.dataset_id }}_{{ var.json.new_york.container_registry.311_service_requests.destination_table }}.csv",
            "PROJECT_ID": "{{ var.value.gcp_project }}",
            "DATASET_ID": "{{ var.json.new_york.container_registry.311_service_requests.dataset_id }}",
            "TABLE_ID": "{{ var.json.new_york.container_registry.311_service_requests.destination_table }}",
    ...
    create_cluster >> transform_csv_ny_311_service_requests >> delete_cluster
