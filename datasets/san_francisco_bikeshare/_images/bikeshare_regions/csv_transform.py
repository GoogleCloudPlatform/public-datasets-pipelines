...
def main(
    ...
    logging.info("San Francisco Bikeshare Regions process started")

    pathlib.Path("./files").mkdir(parents=True, exist_ok=True)
    source_file_stations_json = str(source_file).replace(".csv", "") + "_regions.json"
    ...
    logging.info("San Francisco Regions process completed")
...
def download_file_json(
    ...
    df = pd.DataFrame(json_data["data"]["regions"])
