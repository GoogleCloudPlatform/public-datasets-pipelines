...
def main(
  ...
  service_account: str,
  dataset_name: str,
  table_list: typing.List[str],
  # dataset_versions: typing.List[str],
  timeout: int
) -> None:
  logging.Info(f"Starting transfer of tables from {source_project_id}.{dataset_name} to {target_project_id}.{dataset_name} ...")
  ...
  logging.Info(f"Completed transfer of tables from {source_project_id}.{dataset_name} to {target_project_id}.{dataset_name} ...")
...
if __name__ == "__main__":
    ...
    main(
        ...
        dataset_versions=json.loads(os.environ.get("DATASET_VERSIONS", r"[]")),
