...
with DAG(
    dag_id="world_bank_intl_education.world_bank_intl_education",
    ...
    copy_gcs_to_gcs = bash.BashOperator(
        ...
        bash_command="gcloud storage cp gs://pdp-feeds-staging/RelayWorldBank/Edstats_csv/EdStatsCountry-Series.csv gs://{{ var.value.composer_bucket }}/data/world_bank_intl_education/raw_files/ ;\ngcloud storage cp gs://pdp-feeds-staging/RelayWorldBank/Edstats_csv/EdStatsCountry.csv gs://{{ var.value.composer_bucket }}/data/world_bank_intl_education/raw_files/ ;\ngcloud storage cp gs://pdp-feeds-staging/RelayWorldBank/Edstats_csv/EdStatsSeries.csv gs://{{ var.value.composer_bucket }}/data/world_bank_intl_education/raw_files/ ;\n",
    )
    create_cluster = kubernetes_engine.GKECreateClusterOperator(
        ...
        body={
            "name": "pdp-world-bank-intl-education",
    ...
    country_series_definitions_transform_csv = kubernetes_engine.GKEStartPodOperator(
        ...
        project_id="{{ var.value.gcp_project }}",
        location="us-central1-c",
        cluster_name="pdp-world-bank-intl-education",
        image_pull_policy="Always",
        image="{{ var.json.world_bank_intl_education.container_registry.run_csv_transform_kub }}",
        env_vars={
            "SOURCE_URL": "gs://{{ var.value.composer_bucket }}/data/world_bank_intl_education/raw_files/EdStatsCountry-Series.csv",
            "SOURCE_FILE": "files/EdStatsCountry-Series.csv",
            "PROJECT_ID": "{{ var.value.gcp_project }}",
            "COLUMN_TO_REMOVE": "Unnamed: 3",
            "TARGET_FILE": "files/data_output.csv",
            "TARGET_GCS_BUCKET": "{{ var.value.composer_bucket }}",
            "TARGET_GCS_PATH": "data/world_bank_intl_education/country_series_definitions/data_output.csv",
    ...
    country_series_definitions_load_to_bq = gcs_to_bigquery.GCSToBigQueryOperator(
        ...
        source_objects="data/world_bank_intl_education/country_series_definitions/data_output.csv",
        source_format="CSV",
        destination_project_dataset_table="world_bank_intl_education.country_series_definitions",
        skip_leading_rows=1,
    ...
    country_summary_transform_csv = kubernetes_engine.GKEStartPodOperator(
        ...
        image="{{ var.json.world_bank_intl_education.container_registry.run_csv_transform_kub }}",
        env_vars={
            "SOURCE_URL": "gs://{{ var.value.composer_bucket }}/data/world_bank_intl_education/raw_files/EdStatsCountry.csv",
            "SOURCE_FILE": "files/EdStatsCountry.csv",
            "COLUMN_TO_REMOVE": "Unnamed: 31",
            "TARGET_FILE": "files/data_output.csv",
            "TARGET_GCS_BUCKET": "{{ var.value.composer_bucket }}",
            "TARGET_GCS_PATH": "data/world_bank_intl_education/country_summary/data_output.csv",
    ...
    country_summary_load_to_bq = gcs_to_bigquery.GCSToBigQueryOperator(
        ...
        bucket="{{ var.value.composer_bucket }}",
        source_objects="data/world_bank_intl_education/country_summary/data_output.csv",
        source_format="CSV",
        destination_project_dataset_table="world_bank_intl_education.country_summary",
        skip_leading_rows=1,
        ...
        schema_fields=[
            ...
            {"name": "wb_two_code", "type": "string", "mode": "nullable"},
            {
    ...
    series_summary_transform_csv = kubernetes_engine.GKEStartPodOperator(
        ...
        image="{{ var.json.world_bank_intl_education.container_registry.run_csv_transform_kub }}",
        env_vars={
            "SOURCE_URL": "gs://{{ var.value.composer_bucket }}/data/world_bank_intl_education/raw_files/EdStatsSeries.csv",
            "SOURCE_FILE": "files/EdStatsSeries.csv",
            "COLUMN_TO_REMOVE": "Unnamed: 20",
            "TARGET_FILE": "files/data_output.csv",
            "TARGET_GCS_BUCKET": "{{ var.value.composer_bucket }}",
            "TARGET_GCS_PATH": "data/world_bank_intl_education/series_summary/data_output.csv",
    ...
    series_summary_load_to_bq = gcs_to_bigquery.GCSToBigQueryOperator(
        ...
        bucket="{{ var.value.composer_bucket }}",
        source_objects="data/world_bank_intl_education/series_summary/data_output.csv",
        source_format="CSV",
        destination_project_dataset_table="world_bank_intl_education.series_summary",
        skip_leading_rows=1,
        allow_quoted_newlines=True,
        write_disposition="WRITE_TRUNCATE",
        schema_fields=[
