...
with DAG(
    dag_id="world_bank_intl_education.series_summary",
    ...
    series_summary_transform_csv = kubernetes_pod_operator.KubernetesPodOperator(
        ...
        env_vars={
            "SOURCE_URL": "gs://pdp-feeds-staging/RelayWorldBank/Edstats_csv/EdStatsSeries.csv",
    ...
    load_series_summary_to_bq = gcs_to_bq.GoogleCloudStorageToBigQueryOperator(
        ...
        source_objects=[
            "data/world_bank_intl_education/series_summary/data_output.csv"
        ],
        source_format="CSV",
